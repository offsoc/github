...
module PrometheusExporter
  class << self
    # source://prometheus_exporter//lib/prometheus_exporter.rb#35
    def detect_json_serializer(preferred); end

    # @return [Boolean]
    #
    # source://prometheus_exporter//lib/prometheus_exporter.rb#44
    def has_oj?; end

    # source://prometheus_exporter//lib/prometheus_exporter.rb#24
    def hostname; end
  end
end
...
class PrometheusExporter::OjCompat
  class << self
    # source://prometheus_exporter//lib/prometheus_exporter.rb#19
    def dump(obj); end
