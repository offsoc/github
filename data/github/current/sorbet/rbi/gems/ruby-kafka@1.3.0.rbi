...
class Kafka::AsyncProducer::Worker
  ...
  # source://ruby-kafka//lib/kafka/async_producer.rb#277
  def deliver_messages; end

  # source://ruby-kafka//lib/kafka/async_producer.rb#258
  def produce(value, **kwargs); end

  # @return [Boolean]
  #
  # source://ruby-kafka//lib/kafka/async_producer.rb#285
...
class Kafka::Client
  ...
  # @return [Client]
  #
  # source://ruby-kafka//lib/kafka/client.rb#78
  ...
  # @return [nil]
  #
  # source://ruby-kafka//lib/kafka/client.rb#581
  ...
  # @return [nil]
  #
  # source://ruby-kafka//lib/kafka/client.rb#658
  def alter_topic(name, configs = T.unsafe(nil)); end

  # source://ruby-kafka//lib/kafka/client.rb#775
  def apis; end
  ...
  # @see AsyncProducer
  #
  # source://ruby-kafka//lib/kafka/client.rb#323
  ...
  #
  # source://ruby-kafka//lib/kafka/client.rb#782
  def brokers; end
  ...
  # @return [nil]
  #
  # source://ruby-kafka//lib/kafka/client.rb#796
  def close; end
  ...
  # @return [Consumer]
  #
  # source://ruby-kafka//lib/kafka/client.rb#363
  ...
  #
  # source://ruby-kafka//lib/kafka/client.rb#789
  ...
  # @return [nil]
  #
  # source://ruby-kafka//lib/kafka/client.rb#686
  ...
  # @return [nil]
  #
  # source://ruby-kafka//lib/kafka/client.rb#605
  ...
  # @return [nil]
  #
  # source://ruby-kafka//lib/kafka/client.rb#621
  ...
  # @return [nil]
  #
  # source://ruby-kafka//lib/kafka/client.rb#148
  ...
  #
  # source://ruby-kafka//lib/kafka/client.rb#572
  ...
  #
  # source://ruby-kafka//lib/kafka/client.rb#666
  ...
  #
  # source://ruby-kafka//lib/kafka/client.rb#640
  ...
  # @return [nil]
  #
  # source://ruby-kafka//lib/kafka/client.rb#541
  ...
  #
  # source://ruby-kafka//lib/kafka/client.rb#674
  ...
  #
  # source://ruby-kafka//lib/kafka/client.rb#493
  ...
  #
  # source://ruby-kafka//lib/kafka/client.rb#708
  def groups; end

  # @return [Boolean]
  #
  # source://ruby-kafka//lib/kafka/client.rb#712
  ...
  #
  # source://ruby-kafka//lib/kafka/client.rb#741
  ...
  #
  # source://ruby-kafka//lib/kafka/client.rb#757
  ...
  #
  # source://ruby-kafka//lib/kafka/client.rb#722
  ...
  #
  # source://ruby-kafka//lib/kafka/client.rb#261
  ...
  #
  # source://ruby-kafka//lib/kafka/client.rb#730
  ...
  # @return [Boolean]
  #
  # source://ruby-kafka//lib/kafka/client.rb#771
  ...
  #
  # source://ruby-kafka//lib/kafka/client.rb#693
  def topics; end

  private

  # source://ruby-kafka//lib/kafka/client.rb#802
  def initialize_cluster; end

  # source://ruby-kafka//lib/kafka/client.rb#815
...
class Kafka::Cluster
  ...
  #
  # source://ruby-kafka//lib/kafka/cluster.rb#21
  ...
  # @return [nil]
  #
  # source://ruby-kafka//lib/kafka/cluster.rb#42
  def add_target_topics(topics); end

  # source://ruby-kafka//lib/kafka/cluster.rb#163
  def alter_configs(broker_id, configs = T.unsafe(nil)); end

  # source://ruby-kafka//lib/kafka/cluster.rb#268
  def alter_topic(name, configs = T.unsafe(nil)); end

  # source://ruby-kafka//lib/kafka/cluster.rb#61
  def api_info(api_key); end

  # source://ruby-kafka//lib/kafka/cluster.rb#76
  def apis; end
  ...
  #
  # source://ruby-kafka//lib/kafka/cluster.rb#91
  def clear_target_topics; end

  # source://ruby-kafka//lib/kafka/cluster.rb#401
  def cluster_info; end

  # source://ruby-kafka//lib/kafka/cluster.rb#307
  def create_partitions_for(name, num_partitions:, timeout:); end

  # source://ruby-kafka//lib/kafka/cluster.rb#189
  def create_topic(name, num_partitions:, replication_factor:, timeout:, config:); end

  # source://ruby-kafka//lib/kafka/cluster.rb#230
  def delete_topic(name, timeout:); end

  # source://ruby-kafka//lib/kafka/cluster.rb#146
  def describe_configs(broker_id, configs = T.unsafe(nil)); end

  # source://ruby-kafka//lib/kafka/cluster.rb#286
  def describe_group(group_id); end

  # source://ruby-kafka//lib/kafka/cluster.rb#249
  def describe_topic(name, configs = T.unsafe(nil)); end

  # source://ruby-kafka//lib/kafka/cluster.rb#397
  def disconnect; end

  # source://ruby-kafka//lib/kafka/cluster.rb#293
  def fetch_group_offsets(group_id); end
  ...
  #
  # source://ruby-kafka//lib/kafka/cluster.rb#122
  ...
  #
  # source://ruby-kafka//lib/kafka/cluster.rb#114
  ...
  # @return [Broker] the broker that's currently coordinator.
  #
  # source://ruby-kafka//lib/kafka/cluster.rb#132
  def get_transaction_coordinator(transactional_id:); end

  # source://ruby-kafka//lib/kafka/cluster.rb#388
  def list_groups; end

  # Lists all topics in the cluster.
  #
  # source://ruby-kafka//lib/kafka/cluster.rb#381
  def list_topics; end

  # source://ruby-kafka//lib/kafka/cluster.rb#96
  def mark_as_stale!; end

  # source://ruby-kafka//lib/kafka/cluster.rb#180
  def partitions_for(topic); end

  # source://ruby-kafka//lib/kafka/cluster.rb#100
  def refresh_metadata!; end

  # source://ruby-kafka//lib/kafka/cluster.rb#105
  def refresh_metadata_if_necessary!; end

  # source://ruby-kafka//lib/kafka/cluster.rb#369
  def resolve_offset(topic, partition, offset); end

  # source://ruby-kafka//lib/kafka/cluster.rb#327
  def resolve_offsets(topic, partitions, offset); end

  # @return [Boolean]
  #
  # source://ruby-kafka//lib/kafka/cluster.rb#65
  def supports_api?(api_key, version = T.unsafe(nil)); end

  # source://ruby-kafka//lib/kafka/cluster.rb#373
  def topics; end
  ...
  #
  # source://ruby-kafka//lib/kafka/cluster.rb#419
  def fetch_cluster_info; end

  # @raise [Kafka::Error]
  #
  # source://ruby-kafka//lib/kafka/cluster.rb#467
  def get_coordinator(coordinator_type, coordinator_key); end

  # source://ruby-kafka//lib/kafka/cluster.rb#407
  def get_leader_id(topic, partition); end

  # source://ruby-kafka//lib/kafka/cluster.rb#451
...
class Kafka::ConsumerGroup
  ...
  # source://ruby-kafka//lib/kafka/consumer_group.rb#216
  def coordinator; end
...
class Kafka::Partitioner
  ...
  #
  # source://ruby-kafka//lib/kafka/partitioner.rb#22
...
class Kafka::Protocol::AddOffsetsToTxnResponse
  ...
  class << self
    # source://ruby-kafka//lib/kafka/protocol/add_offsets_to_txn_response.rb#11
...
class Kafka::Protocol::TxnOffsetCommitResponse
  ...
  class << self
    # source://ruby-kafka//lib/kafka/protocol/txn_offset_commit_response.rb#11
    def decode(decoder); end
  end
end
...
class Kafka::SaslAuthenticator
  ...
  # source://ruby-kafka//lib/kafka/sasl_authenticator.rb#48
  def authenticate!(connection); end

  # @return [Boolean]
  #
  # source://ruby-kafka//lib/kafka/sasl_authenticator.rb#44
  def enabled?; end
end
...
class Kafka::TransactionManager
  ...
  # source://ruby-kafka//lib/kafka/transaction_manager.rb#258
  def close; end
  ...
  # @return [Boolean]
  #
  # source://ruby-kafka//lib/kafka/transaction_manager.rb#250
  def error?; end
  ...
  # @return [Boolean]
  #
  # source://ruby-kafka//lib/kafka/transaction_manager.rb#246
  def in_transaction?; end
  ...
  # @return [Boolean]
  #
  # source://ruby-kafka//lib/kafka/transaction_manager.rb#254
  def ready?; end
  ...
  # source://ruby-kafka//lib/kafka/transaction_manager.rb#286
  def complete_transaction; end

  # source://ruby-kafka//lib/kafka/transaction_manager.rb#270
  def force_transactional!; end

  # source://ruby-kafka//lib/kafka/transaction_manager.rb#280
