...
# This is an autogenerated file for dynamic methods in `Blackbird::Query::V2::SearchResult`.
# Please instead update this file by running `bin/tapioca dsl Blackbird::Query::V2::SearchResult`.
...
class Blackbird::Query::V2::SearchResult
  sig do
    params(
      ...
      debug_info: T.nilable(Blackbird::Query::V2::DebugInfo),
      duplicate_locations: T.nilable(T.any(Google::Protobuf::RepeatedField[Blackbird::Query::V2::DuplicateLocationInfo], T::Array[Blackbird::Query::V2::DuplicateLocationInfo])),
  ...
  sig { returns(T.nilable(Blackbird::Query::V2::DebugInfo)) }
  def debug_info; end

  sig { params(value: T.nilable(Blackbird::Query::V2::DebugInfo)).void }
  def debug_info=(value); end

  sig { returns(Google::Protobuf::RepeatedField[Blackbird::Query::V2::DuplicateLocationInfo]) }
  def duplicate_locations; end

  sig { params(value: Google::Protobuf::RepeatedField[Blackbird::Query::V2::DuplicateLocationInfo]).void }
  ...
  sig { returns(Google::Protobuf::RepeatedField[Blackbird::Query::V2::RenderedSnippet]) }
  def snippets; end

  sig { params(value: Google::Protobuf::RepeatedField[Blackbird::Query::V2::RenderedSnippet]).void }
  def snippets=(value); end

  sig { returns(Google::Protobuf::RepeatedField[Blackbird::Query::V2::Range]) }
  def term_matches; end

  sig { params(value: Google::Protobuf::RepeatedField[Blackbird::Query::V2::Range]).void }
