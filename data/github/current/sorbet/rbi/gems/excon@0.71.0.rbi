...
# source://excon//lib/excon/connection.rb#3
class Excon::Connection
  ...
  #
  # source://excon//lib/excon/connection.rb#62
  ...
  # source://excon//lib/excon/connection.rb#376
  def inspect; end

  # source://excon//lib/excon/connection.rb#35
  def logger; end

  # source://excon//lib/excon/connection.rb#40
  def logger=(logger); end

  # source://excon//lib/excon/connection.rb#360
  def options(params = T.unsafe(nil), &block); end

  # source://excon//lib/excon/connection.rb#17
  def params; end

  # source://excon//lib/excon/connection.rb#21
  ...
  # source://excon//lib/excon/connection.rb#26
  def proxy; end

  # source://excon//lib/excon/connection.rb#30
  ...
  # @param pipeline_params [Array<Hash>] An array of one or more optional params, override defaults set in Connection.new, see #request for details
  #
  # source://excon//lib/excon/connection.rb#312
  ...
  # source://excon//lib/excon/connection.rb#366
  ...
  # source://excon//lib/excon/connection.rb#483
  def raise_socket_error(error); end

  # source://excon//lib/excon/connection.rb#447
  def response(datum = T.unsafe(nil)); end

  # source://excon//lib/excon/connection.rb#491
  def setup_proxy; end
  ...
  # source://excon//lib/excon/connection.rb#421
  def validate_params(validation, params, middlewares); end

  class << self
    # source://webmock/3.20.0/lib/webmock/http_lib_adapters/excon_adapter.rb#157
...
#
# source://excon//lib/excon/constants.rb#131
...
# source://excon//lib/excon/constants.rb#107
...
class Excon::Error < ::StandardError
  class << self
    ...
    #
    # source://excon//lib/excon/error.rb#164
...
# source://excon//lib/excon/error.rb#72
...
# 100
#
# source://excon//lib/excon/error.rb#75
class Excon::Error::Continue < ::Excon::Error::Informational; end

# 201
#
# source://excon//lib/excon/error.rb#78
...
# 300
#
# source://excon//lib/excon/error.rb#84
...
# 200
#
# source://excon//lib/excon/error.rb#77
...
# source://excon//lib/excon/error.rb#53
class Excon::Error::ProxyConnectionError < ::Excon::Error; end
...
# source://excon//lib/excon/error.rb#73
...
# source://excon//lib/excon/error.rb#70
class Excon::Error::Success < ::Excon::Error::HTTPStatus; end

# 101
#
# source://excon//lib/excon/error.rb#76
...
# Legacy
#
# source://excon//lib/excon/error.rb#189
module Excon::Errors
  class << self
    # source://excon//lib/excon/error.rb#215
    def status_error(request, response); end
  end
end

# source://excon//lib/excon/error.rb#212
...
# source://excon//lib/excon/error.rb#190
...
class Excon::Headers < ::Hash
  ...
  # source://excon//lib/excon/headers.rb#28
  def [](key); end

  # source://excon//lib/excon/headers.rb#33
  def []=(key, value); end

  # source://excon//lib/excon/headers.rb#39
  def assoc(obj); end

  # source://excon//lib/excon/headers.rb#44
  def delete(key, &proc); end

  # source://excon//lib/excon/headers.rb#49
  def fetch(key, default = T.unsafe(nil), &proc); end

  # @return [Boolean]
  #
  # source://excon//lib/excon/headers.rb#59
  def has_key?(key); end

  # source://excon//lib/excon/headers.rb#63
  def merge(other_hash); end

  # source://excon//lib/excon/headers.rb#67
  def merge!(other_hash); end
  ...
  # source://excon//lib/excon/headers.rb#74
  def rehash; end

  # source://excon//lib/excon/headers.rb#79
...
class Excon::Middleware::Decompress < ::Excon::Middleware::Base
  ...
  # source://excon//lib/excon/middlewares/decompress.rb#15
  def response_call(datum); end
end
...
class Excon::Response
  ...
  #
  # source://excon//lib/excon/response.rb#197
  def initialize(params = T.unsafe(nil)); end

  # source://excon//lib/excon/response.rb#211
  def [](key); end
  ...
  #
  # source://excon//lib/excon/response.rb#226
  ...
  # source://excon//lib/excon/response.rb#215
  def params; end
  ...
  # source://excon//lib/excon/response.rb#220
  def pp; end
  ...
  class << self
    ...
    # source://excon//lib/excon/response.rb#177
...
class Excon::SSLSocket < ::Excon::Socket
  ...
  # source://excon//lib/excon/ssl_socket.rb#151
  def client_cert_data; end

  # source://excon//lib/excon/ssl_socket.rb#168
  def client_key_data; end

  # source://excon//lib/excon/ssl_socket.rb#179
  def client_key_pass; end

  # source://excon//lib/excon/ssl_socket.rb#162
  def connect; end
end
...
# source://excon//lib/excon/socket.rb#3
class Excon::Socket
  include ::Excon::Utils
  extend ::Forwardable
  ...
  # Returns the value of attribute data.
  #
  # source://excon//lib/excon/socket.rb#8
  def data; end
  ...
  # source://excon//lib/excon/socket.rb#77
  def legacy_readline; end

  # source://excon//lib/excon/socket.rb#95
  def local_address; end

  # source://excon//lib/excon/socket.rb#99
  def local_port; end

  # source://excon//lib/excon/socket.rb#27
  def params; end

  # source://excon//lib/excon/socket.rb#32
  def params=(new_params); end

  # source://excon//lib/excon/socket.rb#50
  def read(max_length = T.unsafe(nil)); end

  # source://excon//lib/excon/socket.rb#60
  def readline; end

  # Returns the value of attribute remote_ip.
  #
  # source://excon//lib/excon/socket.rb#37
  def remote_ip; end

  # source://excon//lib/excon/socket.rb#87
  def write(data); end
...
module Excon::Utils
  ...
  # source://excon//lib/excon/utils.rb#19
  def connection_uri(datum = T.unsafe(nil)); end

  # Escapes HTTP reserved and unwise characters in +str+
  #
  # source://excon//lib/excon/utils.rb#98
  ...
  #
  # source://excon//lib/excon/utils.rb#31
  ...
  #
  # source://excon//lib/excon/utils.rb#89
