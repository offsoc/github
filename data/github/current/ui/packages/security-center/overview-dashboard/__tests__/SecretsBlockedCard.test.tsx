...
import {SecretsBlockedCard} from '../components/SecretsBlockedCard'
...
describe('SecretsBlockedCard', () => {
  ...
  it('renders the component with the correct props', () => {
    ...
    render(
      <SecretsBlockedCard query={query} customProperties={customProperties} startDate={startDate} endDate={endDate} />,
    )
  ...
  it('renders the component with fetched data', async () => {
    ...
    expect(await screen.findByText(`7,331`)).toBeInTheDocument()
  ...
  describe('renders action link', () => {
    it('with only supported query filters', async () => {
      ...
      render(
        <SecretsBlockedCard
          query="archived:false tool:github secret-scanning.provider:test secret-scanning.blocked:true severity:critical props.woof:123"
          customProperties={customProperties}
          startDate={startDate}
          endDate={endDate}
        />,
