...
# This is an autogenerated file for types exported from the `github-proto-support` gem.
# Please instead update this file by running `bin/tapioca gem github-proto-support`.

# source://github-proto-support//lib/github/proto/support/version.rb#3
module GitHub
...
# source://github-proto-support//lib/github/proto/support/version.rb#4
module GitHub::Proto; end

# source://github-proto-support//lib/github/proto/support/version.rb#5
module GitHub::Proto::Support; end

# source://github-proto-support//lib/github-proto-support.rb#12
class GitHub::Proto::Support::Error < ::StandardError; end

# source://github-proto-support//lib/github/proto/support/v1/abuse_reports_api_pb.rb#24
module GitHub::Proto::Support::V1; end

# source://github-proto-support//lib/github/proto/support/v1/abuse_reports_api_twirp.rb#15
class GitHub::Proto::Support::V1::AbuseReportsAPIClient < ::Twirp::Client
  # source://twirp/1.10.0/lib/twirp/client.rb#42
  def create_abuse_report(input, req_opts = T.unsafe(nil)); end
end

# source://github-proto-support//lib/github/proto/support/v1/abuse_reports_api_twirp.rb#9
class GitHub::Proto::Support::V1::AbuseReportsAPIService < ::Twirp::Service; end

class GitHub::Proto::Support::V1::CreateAbuseReportRequest
...
class GitHub::Proto::Support::V1::GetBillingInfoRequest
  include ::Google::Protobuf::MessageExts
  extend ::Google::Protobuf::MessageExts::ClassMethods
...
class GitHub::Proto::Support::V1::UserOrganizationsInfoResultItem
  include ::Google::Protobuf::MessageExts
  extend ::Google::Protobuf::MessageExts::ClassMethods
...
# source://github-proto-support//lib/github/proto/support/v1/users_api_twirp.rb#16
class GitHub::Proto::Support::V1::UsersAPIClient < ::Twirp::Client
  # source://twirp/1.10.0/lib/twirp/client.rb#42
...
# source://github-proto-support//lib/github/proto/support/v1/users_api_twirp.rb#9
class GitHub::Proto::Support::V1::UsersAPIService < ::Twirp::Service; end

# source://github-proto-support//lib/github/proto/support/version.rb#6
GitHub::Proto::Support::VERSION = T.let(T.unsafe(nil), String)
