...
# source://better_html//lib/better_html/test_helper/safety_error.rb#4
module BetterHtml::TestHelper; end

# source://better_html//lib/better_html/test_helper/ruby_node.rb#8
class BetterHtml::TestHelper::RubyNode < ::BetterHtml::AST::Node
  # source://better_html//lib/better_html/test_helper/ruby_node.rb#96
  def arguments; end

  # @return [Boolean]
  #
  # source://better_html//lib/better_html/test_helper/ruby_node.rb#88
  def begin?; end

  # source://better_html//lib/better_html/test_helper/ruby_node.rb#32
  def child_nodes; end

  # @return [Boolean]
  #
  # source://better_html//lib/better_html/test_helper/ruby_node.rb#80
  def hash?; end

  # @return [Boolean]
  #
  # source://better_html//lib/better_html/test_helper/ruby_node.rb#76
  def method_call?; end

  # source://better_html//lib/better_html/test_helper/ruby_node.rb#92
  def method_name; end

  # @return [Boolean]
  #
  # source://better_html//lib/better_html/test_helper/ruby_node.rb#104
  def method_name?(name); end

  # @return [Boolean]
  #
  # source://better_html//lib/better_html/test_helper/ruby_node.rb#36
  def node?(current); end

  # @return [Boolean]
  #
  # source://better_html//lib/better_html/test_helper/ruby_node.rb#84
  def pair?; end

  # source://better_html//lib/better_html/test_helper/ruby_node.rb#100
  def receiver; end

  # source://better_html//lib/better_html/test_helper/ruby_node.rb#51
  def return_values; end

  # @return [Boolean]
  #
  # source://better_html//lib/better_html/test_helper/ruby_node.rb#70
  def static_return_value?; end

  # @return [Boolean]
  #
  # source://better_html//lib/better_html/test_helper/ruby_node.rb#46
  def static_value?; end

  # @return [Boolean]
  #
  # source://better_html//lib/better_html/test_helper/ruby_node.rb#40
  def type?(wanted_type); end

  class << self
    # source://better_html//lib/better_html/test_helper/ruby_node.rb#20
    def parse(code); end
  end
end

# source://better_html//lib/better_html/test_helper/ruby_node.rb#9
BetterHtml::TestHelper::RubyNode::BLOCK_EXPR = T.let(T.unsafe(nil), Regexp)

# source://better_html//lib/better_html/test_helper/ruby_node.rb#13
class BetterHtml::TestHelper::RubyNode::Builder < ::Parser::Builders::Default
  # source://better_html//lib/better_html/test_helper/ruby_node.rb#14
  def n(type, children, source_map); end
end

# source://better_html//lib/better_html/test_helper/ruby_node.rb#11
class BetterHtml::TestHelper::RubyNode::ParseError < ::RuntimeError; end

# source://better_html//lib/better_html/test_helper/ruby_node.rb#44
BetterHtml::TestHelper::RubyNode::STATIC_TYPES = T.let(T.unsafe(nil), Array)

# source://better_html//lib/better_html/test_helper/safe_erb/base.rb#10
module BetterHtml::TestHelper::SafeErb; end

# source://better_html//lib/better_html/test_helper/safe_erb/allowed_script_type.rb#8
class BetterHtml::TestHelper::SafeErb::AllowedScriptType < ::BetterHtml::TestHelper::SafeErb::Base
  # source://better_html//lib/better_html/test_helper/safe_erb/allowed_script_type.rb#11
  def validate; end

  private

  # source://better_html//lib/better_html/test_helper/safe_erb/allowed_script_type.rb#19
  def validate_type(tag); end
end

# source://better_html//lib/better_html/test_helper/safe_erb/allowed_script_type.rb#9
BetterHtml::TestHelper::SafeErb::AllowedScriptType::VALID_JAVASCRIPT_TAG_TYPES = T.let(T.unsafe(nil), Array)

# source://better_html//lib/better_html/test_helper/safe_erb/base.rb#11
class BetterHtml::TestHelper::SafeErb::Base
  # @return [Base] a new instance of Base
  #
  # source://better_html//lib/better_html/test_helper/safe_erb/base.rb#14
  def initialize(parser, config: T.unsafe(nil)); end

  # source://better_html//lib/better_html/test_helper/safe_erb/base.rb#20
  def add_error(message, location:); end

  # Returns the value of attribute errors.
  #
  # source://better_html//lib/better_html/test_helper/safe_erb/base.rb#12
  def errors; end

  protected

  # source://better_html//lib/better_html/test_helper/safe_erb/base.rb#53
  def ast; end

  # source://better_html//lib/better_html/test_helper/safe_erb/base.rb#26
  def erb_nodes(root_node); end

  # source://better_html//lib/better_html/test_helper/safe_erb/base.rb#37
  def script_tags; end
end

# source://better_html//lib/better_html/test_helper/safe_erb/no_javascript_tag_helper.rb#9
class BetterHtml::TestHelper::SafeErb::NoJavascriptTagHelper < ::BetterHtml::TestHelper::SafeErb::Base
  # source://better_html//lib/better_html/test_helper/safe_erb/no_javascript_tag_helper.rb#10
  def validate; end

  private

  # source://better_html//lib/better_html/test_helper/safe_erb/no_javascript_tag_helper.rb#16
  def no_javascript_tag_helper(node); end
end

# source://better_html//lib/better_html/test_helper/safe_erb/no_statements.rb#8
class BetterHtml::TestHelper::SafeErb::NoStatements < ::BetterHtml::TestHelper::SafeErb::Base
  # source://better_html//lib/better_html/test_helper/safe_erb/no_statements.rb#9
  def validate; end

  private

  # source://better_html//lib/better_html/test_helper/safe_erb/no_statements.rb#27
  def no_statements(node); end
end

# source://better_html//lib/better_html/test_helper/safe_erb/script_interpolation.rb#9
class BetterHtml::TestHelper::SafeErb::ScriptInterpolation < ::BetterHtml::TestHelper::SafeErb::Base
  # source://better_html//lib/better_html/test_helper/safe_erb/script_interpolation.rb#10
  def validate; end

  private

  # source://better_html//lib/better_html/test_helper/safe_erb/script_interpolation.rb#26
  def validate_script(node); end

  # source://better_html//lib/better_html/test_helper/safe_erb/script_interpolation.rb#46
  def validate_script_interpolation(parent_node, ruby_node); end
end

# source://better_html//lib/better_html/test_helper/safe_erb/tag_interpolation.rb#9
class BetterHtml::TestHelper::SafeErb::TagInterpolation < ::BetterHtml::TestHelper::SafeErb::Base
  # source://better_html//lib/better_html/test_helper/safe_erb/tag_interpolation.rb#23
  def validate; end

  private

  # source://better_html//lib/better_html/test_helper/safe_erb/tag_interpolation.rb#127
  def handle_missing_safe_wrapper(parent_node, ruby_node, attr_name); end

  # source://better_html//lib/better_html/test_helper/safe_erb/tag_interpolation.rb#182
  def nested_location(parent_node, ruby_node); end

  # @return [Boolean]
  #
  # source://better_html//lib/better_html/test_helper/safe_erb/tag_interpolation.rb#38
  def no_html_tag?(node); end

  # source://better_html//lib/better_html/test_helper/safe_erb/tag_interpolation.rb#166
  def no_unsafe_calls(parent_node, ruby_node); end

  # source://better_html//lib/better_html/test_helper/safe_erb/tag_interpolation.rb#48
  def validate_attribute(attribute); end

  # source://better_html//lib/better_html/test_helper/safe_erb/tag_interpolation.rb#95
  def validate_ruby_helper(parent_node, ruby_node); end

  # source://better_html//lib/better_html/test_helper/safe_erb/tag_interpolation.rb#105
  def validate_ruby_helper_hash_entry(parent_node, ruby_node, key_prefix, key_node, value_node); end

  # source://better_html//lib/better_html/test_helper/safe_erb/tag_interpolation.rb#121
  def validate_ruby_helper_hash_value(parent_node, ruby_node, attr_name, hash_value); end

  # source://better_html//lib/better_html/test_helper/safe_erb/tag_interpolation.rb#149
  def validate_tag_interpolation(parent_node, ruby_node, attr_name); end

  # source://better_html//lib/better_html/test_helper/safe_erb/tag_interpolation.rb#76
  def validate_text_node(text_node); end
end

# source://better_html//lib/better_html/test_helper/safe_erb/tag_interpolation.rb#10
BetterHtml::TestHelper::SafeErb::TagInterpolation::NO_HTML_TAGS = T.let(T.unsafe(nil), Array)

# source://better_html//lib/better_html/test_helper/safe_erb_tester.rb#15
module BetterHtml::TestHelper::SafeErbTester
  # source://better_html//lib/better_html/test_helper/safe_erb_tester.rb#39
  def assert_erb_safety(data, **options); end
end

# source://better_html//lib/better_html/test_helper/safe_erb_tester.rb#16
BetterHtml::TestHelper::SafeErbTester::SAFETY_TIPS = T.let(T.unsafe(nil), String)

# source://better_html//lib/better_html/test_helper/safety_error.rb#5
class BetterHtml::TestHelper::SafetyError < ::BetterHtml::InterpolatorError
  # @return [SafetyError] a new instance of SafetyError
  #
  # source://better_html//lib/better_html/test_helper/safety_error.rb#8
  def initialize(message, location:); end

  # Returns the value of attribute location.
  #
  # source://better_html//lib/better_html/test_helper/safety_error.rb#6
  def location; end
end
...
# source://better_html//lib/better_html/tree/attribute.rb#6
module BetterHtml::Tree; end

# source://better_html//lib/better_html/tree/attribute.rb#7
class BetterHtml::Tree::Attribute
  # @return [Attribute] a new instance of Attribute
  #
  # source://better_html//lib/better_html/tree/attribute.rb#16
  def initialize(node); end

  # Returns the value of attribute equal_node.
  #
  # source://better_html//lib/better_html/tree/attribute.rb#8
  def equal_node; end

  # @return [Boolean]
  #
  # source://better_html//lib/better_html/tree/attribute.rb#21
  def erb?; end

  # source://better_html//lib/better_html/tree/attribute.rb#25
  def loc; end

  # source://better_html//lib/better_html/tree/attribute.rb#29
  def name; end
  ...
  # source://better_html//lib/better_html/tree/attribute.rb#33
  def value; end
  ...
  class << self
    # source://better_html//lib/better_html/tree/attribute.rb#11
    def from_node(node); end
  end
end

# source://better_html//lib/better_html/tree/attributes_list.rb#7
class BetterHtml::Tree::AttributesList
  # @return [AttributesList] a new instance of AttributesList
  #
  # source://better_html//lib/better_html/tree/attributes_list.rb#14
  def initialize(list); end

  # source://better_html//lib/better_html/tree/attributes_list.rb#18
  def [](name); end

  # source://better_html//lib/better_html/tree/attributes_list.rb#24
  def each(&block); end

  class << self
    # source://better_html//lib/better_html/tree/attributes_list.rb#9
    def from_nodes(nodes); end
  end
end

# source://better_html//lib/better_html/tree/tag.rb#8
class BetterHtml::Tree::Tag
  # @return [Tag] a new instance of Tag
  #
  # source://better_html//lib/better_html/tree/tag.rb#17
  def initialize(node); end

  # source://better_html//lib/better_html/tree/tag.rb#38
  def attributes; end

  # Returns the value of attribute attributes_node.
  #
  # source://better_html//lib/better_html/tree/tag.rb#9
  def attributes_node; end

  # @return [Boolean]
  #
  # source://better_html//lib/better_html/tree/tag.rb#30
  def closing?; end
  ...
  # source://better_html//lib/better_html/tree/tag.rb#22
  def loc; end

  # source://better_html//lib/better_html/tree/tag.rb#26
  def name; end
  ...
  # @return [Boolean]
  #
  # source://better_html//lib/better_html/tree/tag.rb#34
  ...
  class << self
    # source://better_html//lib/better_html/tree/tag.rb#12
    def from_node(node); end
  end
end
