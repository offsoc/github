...
module ActionMailer::Base::HelperMethods
  ...
  # source://actionpack/8.0.0.alpha.d7f9347368/lib/abstract_controller/caching/fragments.rb#34
  def combined_fragment_cache_key(*_arg0, **_arg1, &_arg2); end

  # source://actionpack/8.0.0.alpha.d7f9347368/lib/abstract_controller/caching.rb#45
...
class ActionMailer::MailDeliveryJob < ::ActiveJob::Base
  ...
  class << self
    # source://activejob/8.0.0.alpha.d7f9347368/lib/active_job/queue_name.rb#55
    def queue_name; end
