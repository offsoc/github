...
class Stripe::Quote < ::Stripe::APIResource
  ...
  class << self
    # source://stripe//lib/stripe/resources/quote.rb#71
    def accept(quote, params = T.unsafe(nil), opts = T.unsafe(nil)); end

    # source://stripe//lib/stripe/resources/quote.rb#80
    def cancel(quote, params = T.unsafe(nil), opts = T.unsafe(nil)); end

    # source://stripe//lib/stripe/resources/quote.rb#89
    ...
    # source://stripe//lib/stripe/resources/quote.rb#107
    def list_line_items(quote, params = T.unsafe(nil), opts = T.unsafe(nil)); end

    # source://stripe//lib/stripe/resources/quote.rb#116
...
class Stripe::Tax::CalculationLineItem < ::Stripe::APIResource; end
...
class Stripe::Tax::TransactionLineItem < ::Stripe::APIResource; end
...
class Stripe::Treasury::FinancialAccountFeatures < ::Stripe::APIResource; end
