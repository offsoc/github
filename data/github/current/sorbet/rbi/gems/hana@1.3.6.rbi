...
class Hana::Patch
  ...
  #
  # source://hana//lib/hana.rb#106
  def add(ins, doc); end

  # source://hana//lib/hana.rb#221
  def add_op(dest, key, obj); end

  # @raise [ObjectOperationOnArrayException]
  #
  # source://hana//lib/hana.rb#212
  def check_index(obj, key); end

  # source://hana//lib/hana.rb#155
  def copy(ins, doc); end

  # source://hana//lib/hana.rb#136
  def move(ins, doc); end

  # source://hana//lib/hana.rb#204
  def remove(ins, doc); end

  # source://hana//lib/hana.rb#187
  def replace(ins, doc); end

  # source://hana//lib/hana.rb#229
  def rm_op(obj, key); end

  # source://hana//lib/hana.rb#178
...
Hana::Patch::OP = T.let(T.unsafe(nil), String)
...
# source://hana//lib/hana.rb#101
Hana::Patch::PATH = T.let(T.unsafe(nil), String)

# source://hana//lib/hana.rb#89
Hana::Patch::VALID = T.let(T.unsafe(nil), Hash)

# source://hana//lib/hana.rb#103
