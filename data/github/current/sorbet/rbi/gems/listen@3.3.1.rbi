...
class Listen::Adapter::BSD < ::Listen::Adapter::Base
  ...
  #
  # source://listen//lib/listen/adapter/bsd.rb#103
  ...
  # source://listen//lib/listen/adapter/bsd.rb#96
  def _watch_file(path, queue); end

  # source://listen//lib/listen/adapter/bsd.rb#87
...
class Listen::Adapter::Base
  ...
  #
  # source://listen//lib/listen/adapter/base.rb#18
  ...
  #
  # source://listen//lib/listen/adapter/base.rb#34
  def configure; end
...
class Listen::Adapter::Config
  ...
  #
  # source://listen//lib/listen/adapter/config.rb#13
...
class Listen::Adapter::Linux < ::Listen::Adapter::Base
  ...
  # source://listen//lib/listen/adapter/linux.rb#87
  def _change(event_flags); end

  # source://listen//lib/listen/adapter/linux.rb#32
  def _configure(directory, &callback); end

  # @return [Boolean]
  #
  # source://listen//lib/listen/adapter/linux.rb#98
  def _dir_event?(event); end

  # source://listen//lib/listen/adapter/linux.rb#44
  def _process_event(dir, event); end

  # source://listen//lib/listen/adapter/linux.rb#40
  def _run; end

  # @return [Boolean]
  #
  # source://listen//lib/listen/adapter/linux.rb#77
  def _skip_event?(event); end

  # source://listen//lib/listen/adapter/linux.rb#102
  def _stop; end
end
...
class Listen::Adapter::Polling < ::Listen::Adapter::Base
  ...
  # source://listen//lib/listen/adapter/polling.rb#34
...
class Listen::Adapter::Windows < ::Listen::Adapter::Base
  ...
  # source://listen//lib/listen/adapter/windows.rb#90
  ...
  # source://listen//lib/listen/adapter/windows.rb#47
  def _run; end
...
class Listen::Change
  ...
  #
  # source://listen//lib/listen/change.rb#33
  ...
  # Returns the value of attribute config.
  #
  # source://listen//lib/listen/change.rb#76
  def config; end
end
...
class Listen::Directory
  class << self
    # source://listen//lib/listen/directory.rb#64
    def _async_changes(snapshot, path, previous, options); end

    # source://listen//lib/listen/directory.rb#74
    def _change(snapshot, type, path, options); end

    # @raise [Errno::ENOTDIR]
    #
    # source://listen//lib/listen/directory.rb#84
    def _children(path); end

    # @return [Boolean]
    #
    # source://listen//lib/listen/directory.rb#58
    def ascendant_of?(base, other); end

    # source://listen//lib/listen/directory.rb#8
...
class Listen::Event::Config
  # @return [Config] a new instance of Config
  #
  # source://listen//lib/listen/event/config.rb#10
  def initialize(listener, event_queue, queue_optimizer, wait_for_delay, &block); end

  # source://listen//lib/listen/event/config.rb#28
  def call(*args); end
  ...
  #
  # source://listen//lib/listen/event/config.rb#7
  def event_queue; end
  ...
  # source://listen//lib/listen/event/config.rb#24
...
# source://listen//lib/listen/event/loop.rb#11
class Listen::Event::Loop
  ...
  # source://listen//lib/listen/event/loop.rb#61
  def pause; end

  # source://listen//lib/listen/event/loop.rb#43
  def start; end
  ...
  # source://listen//lib/listen/event/loop.rb#66
  def stop; end

  # @return [Boolean]
  #
  # source://listen//lib/listen/event/loop.rb#73
  def stopped?; end
  ...
  # source://listen//lib/listen/event/loop.rb#79
  def _process_changes; end

  # source://listen//lib/listen/event/loop.rb#87
...
# source://listen//lib/listen/event/processor.rb#5
class Listen::Event::Processor
  ...
  # points in time
  #
  # source://listen//lib/listen/event/processor.rb#15
  ...
  # @raise [Stopped]
  #
  # source://listen//lib/listen/event/processor.rb#53
  def _check_stopped; end

  # source://listen//lib/listen/event/processor.rb#80
  def _deadline; end

  # source://listen//lib/listen/event/processor.rb#92
  ...
  # source://listen//lib/listen/event/processor.rb#72
  def _remember_time_of_first_unprocessed_event; end

  # source://listen//lib/listen/event/processor.rb#76
  def _reset_no_unprocessed_events; end

  # source://listen//lib/listen/event/processor.rb#60
  def _sleep(seconds); end

  # source://listen//lib/listen/event/processor.rb#99
  def _timestamp; end

  # blocks until event is popped
  # returns the event or `nil` when the event_queue is closed
  #
  # source://listen//lib/listen/event/processor.rb#86
  def _wait_until_events; end

  # source://listen//lib/listen/event/processor.rb#34
  def _wait_until_events_calm_down; end

  # source://listen//lib/listen/event/processor.rb#49
...
# source://listen//lib/listen/event/processor.rb#31
...
class Listen::Event::Queue
  ...
  # source://listen//lib/listen/event/queue.rb#46
...
module Listen::FSM
  ...
  # source://listen//lib/listen/fsm.rb#105
  def current_state; end

  # source://listen//lib/listen/fsm.rb#66
  def transition(new_state_name); end

  # Low-level, immediate state transition with no checks or callbacks.
  #
  # source://listen//lib/listen/fsm.rb#74
  def transition!(new_state_name); end

  # source://listen//lib/listen/fsm.rb#100
  def transition_with_callbacks!(new_state); end

  # source://listen//lib/listen/fsm.rb#84
...
# source://listen//lib/listen/fsm.rb#109
...
class Listen::File
  class << self
    # source://listen//lib/listen/file.rb#7
    def change(record, rel_path); end

    # @return [Boolean]
    #
    # source://listen//lib/listen/file.rb#78
...
class Listen::Listener
  ...
  # @yieldparam removed [Array<String>] the list of removed files
  #
  # source://listen//lib/listen/listener.rb#36
  def initialize(*dirs, &block); end

  # source://listen//lib/listen/listener.rb#122
  def ignore(regexps); end

  # source://listen//lib/listen/listener.rb#126
  def ignore!(regexps); end
  ...
  #
  # source://listen//lib/listen/listener.rb#105
  def pause; end

  # @return [Boolean]
  #
  # source://listen//lib/listen/listener.rb#114
  def paused?; end
  ...
  # @return [Boolean]
  #
  # source://listen//lib/listen/listener.rb#110
  def processing?; end

  # Starts processing events and starts adapters
  # or resumes invoking callbacks if paused
  #
  # source://listen//lib/listen/listener.rb#87
  def start; end

  # Stops both listening for events and processing them
  #
  # source://listen//lib/listen/listener.rb#100
  def stop; end

  # @return [Boolean]
  #
  # source://listen//lib/listen/listener.rb#118
  def stopped?; end
end
...
class Listen::Listener::Config
  ...
  # source://listen//lib/listen/listener/config.rb#32
  def adapter_instance_options(klass); end

  # source://listen//lib/listen/listener/config.rb#37
...
class Listen::QueueOptimizer
  ...
  # source://listen//lib/listen/queue_optimizer.rb#109
...
class Listen::Record
  ...
  # source://listen//lib/listen/record.rb#18
  ...
  # source://listen//lib/listen/record.rb#33
  ...
  # source://listen//lib/listen/record.rb#28
  def unset_path(rel_path); end

  # source://listen//lib/listen/record.rb#23
  def update_file(rel_path, data); end

  private

  # source://listen//lib/listen/record.rb#87
  def _auto_hash; end

  # source://listen//lib/listen/record.rb#114
  def _fast_build_dir(remaining, symlink_detector); end

  # source://listen//lib/listen/record.rb#126
  def _fast_try_file(entry); end

  # source://listen//lib/listen/record.rb#102
  def _fast_unset_path(dirname, basename); end

  # source://listen//lib/listen/record.rb#93
...
# source://listen//lib/listen/record/symlink_detector.rb#8
...
# source://listen//lib/listen/record/symlink_detector.rb#21
class Listen::Record::SymlinkDetector::Error < ::RuntimeError; end

# source://listen//lib/listen/record/symlink_detector.rb#11
...
class Listen::Silencer
  ...
  #
  # source://listen//lib/listen/silencer.rb#62
  def initialize; end

  # source://listen//lib/listen/silencer.rb#66
  def configure(options); end

  # Returns the value of attribute ignore_patterns.
  #
  # source://listen//lib/listen/silencer.rb#60
  ...
  # @return [Boolean]
  #
  # source://listen//lib/listen/silencer.rb#75
  ...
  # Returns the value of attribute options.
  #
  # source://listen//lib/listen/silencer.rb#87
  def options; end
end
...
#
# source://listen//lib/listen/silencer.rb#20
...
module Listen::Thread
  class << self
    ...
    #
    # source://listen//lib/listen/thread.rb#12
    def new(name, &block); end

    # source://listen//lib/listen/thread.rb#23
    def rescue_and_log(method_name, *args, caller_stack: T.unsafe(nil)); end

    private

    # source://listen//lib/listen/thread.rb#41
    def _exception_with_causes(ex); end

    # source://listen//lib/listen/thread.rb#31
