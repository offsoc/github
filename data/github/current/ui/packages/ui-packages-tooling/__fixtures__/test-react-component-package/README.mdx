...
import TestReactComponentPackageMeta from './TestReactComponentPackage.stories'

<Meta of={ TestReactComponentPackageMeta } />

# TestReactComponentPackage
...
{/* <ArgTypes of={ TestReactComponentPackage } /> */}
