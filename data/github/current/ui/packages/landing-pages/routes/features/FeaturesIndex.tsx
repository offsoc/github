...
const renderItemsForSection = (sectionId: string) => {
  ...
  return section.items.map((item: Item, index) => (
    <Grid.Column span={{xsmall: 12, medium: 4}} key={index}>
    ...
    <ThemeProvider colorMode="dark" className="fp-hasFontSmoothing">
      ...
      <section id="hero" className="lp-Section--hero">
        ...
        <div className="fp-Section-container">
          <Hero data-hpc align="center" className="fp-Hero">
            <Hero.Heading size="2">The tools you need to build what you want.</Hero.Heading>
          </Hero>

          <Spacer size="40px" size1012="80px" />

          <Bento>
            <Bento.Item visualAsBackground columnSpan={{xsmall: 12, medium: 6}}>
              ...
              <Bento.Visual>
                <Image src="/images/modules/site/features/fp24/hero-bento-1.webp" alt="TODO" width="600" />
              </Bento.Visual>
            </Bento.Item>
            ...
            <Bento.Item visualAsBackground columnSpan={{xsmall: 12, medium: 6}}>
              ...
              <Bento.Visual>
                <Image src="/images/modules/site/features/fp24/hero-bento-2.webp" alt="TODO" width="600" />
              </Bento.Visual>
            </Bento.Item>
          </Bento>
      ...
      <section id="features-security" className="fp-Section--isRaised lp-Cards--isRaised">
        <div className="fp-Section-container">
          ...
          <SectionIntro className="fp-SectionIntro" align="center" fullWidth>
            <SectionIntro.Heading size="3">Security</SectionIntro.Heading>
          </SectionIntro>
            ...
            <RiverBreakout.Content
              ...
              trailingComponent={() => (
                <Timeline>
                  ...
                  <Timeline.Item>
                    <em>Automatically detect and deactivate secrets</em> committed to your repos.
                  </Timeline.Item>
                </Timeline>
              )}
            >
              <Text>
                <em>Secure code as you write it.</em> Automatically.
              </Text>
            </RiverBreakout.Content>
          </RiverBreakout>
          ...
          <Image
            width={64}
            height={64}
            src="/images/modules/site/features/fp24/intro-security-advanced.webp"
            alt=""
            style={{display: 'block', margin: '0 auto'}}
          />

          <Spacer size="16px" size1012="24px" />

          <CTABanner
            className="lp-CTABanner--advancedSecurity"
            align="center"
            hasBorder={false}
            hasBackground={false}
            hasShadow={false}
          >
            ...
            <CTABanner.Description>
              Additional features available to GitHub Enterprise customers. With application security tools at their
              fingertips, developers fix vulnerabilities up to 7x faster than those using third-party tools.
            </CTABanner.Description>
            <CTABanner.ButtonGroup buttonsAs="a">
              <Button href="TODO">Contact sales</Button>
              <Button href="TODO">Request a demo</Button>
          ...
          <Grid className="lp-Grid">
            {/* Render items */}
            {renderItemsForSection('security_more')}
          </Grid>
      ...
      <section id="pricing">
        <div className="fp-Section-container">
          ...
          <SectionIntro className="fp-SectionIntro" align="center">
            <SectionIntro.Heading size="3">Ready to get started?</SectionIntro.Heading>
            <SectionIntro.Description>
              Explore all the plans to find the solution that fits your needs.
            </SectionIntro.Description>
            <SectionIntro.Link href="https://github.com/pricing">View pricing plans</SectionIntro.Link>
          </SectionIntro>
