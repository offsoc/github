  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::IssueComment).void)
      ).returns(T.nilable(T::Enumerator[::IssueComment]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::IssueComment]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::IssueComment]]))
    end
