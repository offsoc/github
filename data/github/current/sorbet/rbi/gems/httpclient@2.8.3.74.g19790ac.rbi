...
class HTTP::Message
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#950
  def initialize; end

  # Returns a content of message body.  A String or an IO.
  #
  # source://httpclient//lib/httpclient/http.rb#1040
  def body; end

  # Sets a new body.  header.body_size is updated with new body.size.
  #
  # source://httpclient//lib/httpclient/http.rb#971
  def body=(body); end

  # Returns content encoding
  #
  # source://httpclient//lib/httpclient/http.rb#1035
  def body_encoding; end

  # Returns HTTP status code in response.  Integer.
  #
  # source://httpclient//lib/httpclient/http.rb#999
  def code; end
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#1023
  def content_type; end

  # Sets 'Content-Type' header value.  Overrides if already exists.
  #
  # source://httpclient//lib/httpclient/http.rb#1028
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#1058
  def cookies; end

  # Dumps message (header and body) to given dev.
  # dev needs to respond to <<.
  #
  # source://httpclient//lib/httpclient/http.rb#958
  def dump(dev = T.unsafe(nil)); end

  # HTTP::Message::Headers:: message header.
  #
  # source://httpclient//lib/httpclient/http.rb#934
  def header; end
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#1051
  def headers; end

  # HTTP::Message::Body:: message body.
  #
  # source://httpclient//lib/httpclient/http.rb#937
  def http_body; end
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#978
  def http_version; end

  # Sets HTTP version in a HTTP header.  String.
  #
  # source://httpclient//lib/httpclient/http.rb#983
  ...
  # @return [Boolean]
  #
  # source://httpclient//lib/httpclient/http.rb#1069
  def ok?; end

  # OpenSSL::X509::Certificate:: response only.  server certificate which is
  #                              used for retrieving the response.
  #
  # source://httpclient//lib/httpclient/http.rb#941
  def peer_cert; end
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#945
  def previous; end
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#1013
  def reason; end

  # Sets  HTTP status reason phrase of response.  String.
  #
  # source://httpclient//lib/httpclient/http.rb#1018
  def reason=(reason); end

  # @return [Boolean]
  #
  # source://httpclient//lib/httpclient/http.rb#1073
  def redirect?; end
  ...
  # @return [Boolean]
  #
  # source://httpclient//lib/httpclient/http.rb#1078
  def see_other?; end
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#1008
  ...
  # source://httpclient//lib/httpclient/http.rb#988
  def version; end

  # source://httpclient//lib/httpclient/http.rb#993
  def version=(version); end

  class << self
    # source://httpclient//lib/httpclient/http.rb#853
    def create_query_part_str(query); end

    # source://httpclient//lib/httpclient/http.rb#897
    def escape(str); end

    # source://httpclient//lib/httpclient/http.rb#874
    ...
    # @return [Boolean]
    #
    # source://httpclient//lib/httpclient/http.rb#848
    def file?(obj); end

    # Returns MIME type handler.
    #
    # source://httpclient//lib/httpclient/http.rb#786
    def get_mime_type_func; end

    # Default MIME type handler.
    # See mime_type_handler=.
    #
    # source://httpclient//lib/httpclient/http.rb#809
    ...
    # @return [Boolean]
    #
    # source://httpclient//lib/httpclient/http.rb#832
    def keep_alive_enabled?(version); end

    # source://httpclient//lib/httpclient/http.rb#794
    ...
    #
    # source://httpclient//lib/httpclient/http.rb#781
    ...
    # @return [Boolean]
    #
    # source://httpclient//lib/httpclient/http.rb#837
    ...
    #
    # source://httpclient//lib/httpclient/http.rb#725
    ...
    #
    # source://httpclient//lib/httpclient/http.rb#745
    ...
    #
    # source://httpclient//lib/httpclient/http.rb#761
    def new_response(body, req = T.unsafe(nil)); end

    # from CGI.parse
    #
    # source://httpclient//lib/httpclient/http.rb#911
    def parse(query); end
    ...
    # from CGI.unescape
    #
    # source://httpclient//lib/httpclient/http.rb#925
...
class HTTP::Message::Body
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#457
  def initialize; end

  # maxbytes of IO#read for streaming request.  See DEFAULT_CHUNK_SIZE.
  #
  # source://httpclient//lib/httpclient/http.rb#448
  def chunk_size; end
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#546
  def content; end
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#495
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#446
  def size; end

  private

  # source://httpclient//lib/httpclient/http.rb#664
  def build_query_multipart_str(query, boundary); end

  # source://httpclient//lib/httpclient/http.rb#595
  def dump_chunk(str); end

  # source://httpclient//lib/httpclient/http.rb#603
  def dump_chunk_size(size); end

  # source://httpclient//lib/httpclient/http.rb#588
  def dump_chunks(io, dev); end

  # source://httpclient//lib/httpclient/http.rb#577
  def dump_file(io, dev, sz); end

  # source://httpclient//lib/httpclient/http.rb#599
  def dump_last_chunk; end

  # source://httpclient//lib/httpclient/http.rb#702
  def params_from_file(value); end

  # source://httpclient//lib/httpclient/http.rb#568
  def remember_pos(io); end

  # source://httpclient//lib/httpclient/http.rb#573
  def reset_pos(io); end

  # source://httpclient//lib/httpclient/http.rb#552
  def set_content(body, boundary = T.unsafe(nil)); end
end

# Default value for chunk_size
#
# source://httpclient//lib/httpclient/http.rb#453
...
class HTTP::Message::Body::Parts
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#611
  def initialize; end

  # source://httpclient//lib/httpclient/http.rb#618
  def add(part); end

  # source://httpclient//lib/httpclient/http.rb#646
  def parts; end
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#609
  def sizes; end

  private

  # source://httpclient//lib/httpclient/http.rb#656
  def add_size(part, sz); end
end

# source://httpclient//lib/httpclient/http.rb#102
...
class HTTP::Message::Headers
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#163
  def initialize; end

  # Returns an Array of header values for the given key.
  #
  # source://httpclient//lib/httpclient/http.rb#324
  def [](key); end

  # Adds a header.  See set.
  #
  # source://httpclient//lib/httpclient/http.rb#319
  def []=(key, value); end

  # Adds a header.  Addition order is preserved.
  #
  # source://httpclient//lib/httpclient/http.rb#279
  def add(key, value); end

  # Returns an Array of all headers.
  #
  # source://httpclient//lib/httpclient/http.rb#308
  def all; end

  # Used for dumping response.
  #
  # source://httpclient//lib/httpclient/http.rb#130
  ...
  # Used for dumping response.
  #
  # source://httpclient//lib/httpclient/http.rb#132
  def body_date; end
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#134
  def body_encoding; end

  # Size of body.  nil when size is unknown (e.g. chunked response).
  #
  # source://httpclient//lib/httpclient/http.rb#109
  def body_size; end

  # Sets byte size of message body.
  # body_size == nil means that the body is_a? IO
  #
  # source://httpclient//lib/httpclient/http.rb#255
  def body_size=(body_size); end

  # Used for dumping response.
  #
  # source://httpclient//lib/httpclient/http.rb#128
  def body_type; end
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#111
  def chunked; end
  ...
  # Returns 'Content-Type' header value.
  #
  # source://httpclient//lib/httpclient/http.rb#226
  def content_type; end

  # Sets 'Content-Type' header value.  Overrides if already exists.
  #
  # source://httpclient//lib/httpclient/http.rb#231
  def content_type=(content_type); end
  ...
  # source://httpclient//lib/httpclient/http.rb#347
  def create_query_part; end

  # source://httpclient//lib/httpclient/http.rb#335
  def create_query_uri; end

  # Deletes headers of the given key.
  #
  # source://httpclient//lib/httpclient/http.rb#313
  def delete(key); end

  # Dumps message header part and returns a dumped String.
  #
  # source://httpclient//lib/httpclient/http.rb#260
  def dump; end
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#298
  def get(key = T.unsafe(nil)); end

  # HTTP version in a HTTP header.  String.
  #
  # source://httpclient//lib/httpclient/http.rb#107
  def http_version; end
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#120
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#114
  def request_method; end

  # Request only.  Requested query.
  #
  # source://httpclient//lib/httpclient/http.rb#118
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#116
  def request_uri; end
  ...
  # Sets a header.
  #
  # source://httpclient//lib/httpclient/http.rb#290
  def set(key, value); end

  # source://httpclient//lib/httpclient/http.rb#240
  def set_body_encoding; end

  # Set Date header
  #
  # source://httpclient//lib/httpclient/http.rb#274
  def set_date_header; end

  # source://httpclient//lib/httpclient/http.rb#328
  def set_headers(headers); end

  # Response only.  HTTP status
  #
  # source://httpclient//lib/httpclient/http.rb#123
  def status_code; end

  # Sets status code and reason phrase.
  #
  # source://httpclient//lib/httpclient/http.rb#220
  def status_code=(status_code); end

  private

  # source://httpclient//lib/httpclient/http.rb#432
  def charset_label; end

  # source://httpclient//lib/httpclient/http.rb#364
  def request_line; end

  # source://httpclient//lib/httpclient/http.rb#372
  def response_status_line; end

  # source://httpclient//lib/httpclient/http.rb#380
  def set_header; end

  # source://httpclient//lib/httpclient/http.rb#388
  def set_request_header; end

  # source://httpclient//lib/httpclient/http.rb#410
  def set_response_header; end
end

# $KCODE to charset mapping definition.
#
# source://httpclient//lib/httpclient/http.rb#154
HTTP::Message::Headers::CHARSET_MAP = T.let(T.unsafe(nil), Hash)

# Placeholder URI object for nil uri.
#
# source://httpclient//lib/httpclient/http.rb#196
...
#
# source://httpclient//lib/httpclient/http.rb#137
...
module HTTP::Status
  class << self
    ...
    # @return [Boolean]
    #
    # source://httpclient//lib/httpclient/http.rb#63
    ...
    # @return [Boolean]
    #
    # source://httpclient//lib/httpclient/http.rb#57
...
# source://httpclient//lib/httpclient/http.rb#40
...
#
# source://httpclient//lib/httpclient/http.rb#50
...
#
# source://httpclient//lib/httpclient/http.rb#43
...
class HTTPClient
  ...
  #
  # source://httpclient//lib/httpclient.rb#429
  def initialize(*args, &block); end

  # source://httpclient//lib/httpclient.rb#307
  def agent_name; end

  # source://httpclient//lib/httpclient.rb#312
  def agent_name=(rhs); end

  # Base url of resources.
  #
  # source://httpclient//lib/httpclient.rb#338
  def base_url; end
  ...
  #
  # source://httpclient//lib/httpclient.rb#322
  ...
  #
  # source://httpclient//lib/httpclient.rb#615
  def cookies; end

  # Returns debug device if exists.  See debug_dev=.
  #
  # source://httpclient//lib/httpclient.rb#472
  def debug_dev; end
  ...
  #
  # source://httpclient//lib/httpclient.rb#480
  def debug_dev=(dev); end

  # Default request header.
  #
  # source://httpclient//lib/httpclient.rb#340
  ...
  # in HTTP header.
  #
  # source://httpclient//lib/httpclient.rb#723
  ...
  #
  # source://httpclient//lib/httpclient.rb#912
  def delete_async(uri, *args); end

  # How many times get_content and post_content follows HTTP redirect.
  # 10 by default.
  #
  # source://httpclient//lib/httpclient.rb#336
  ...
  #
  # source://httpclient//lib/httpclient.rb#593
  ...
  #
  # source://httpclient//lib/httpclient.rb#458
  def keep_webmock_compat; end

  # Returns NO_PROXY setting String if given.
  #
  # source://httpclient//lib/httpclient.rb#522
  def no_proxy; end
  ...
  # use post method.
  #
  # source://httpclient//lib/httpclient.rb#691
  ...
  # It immediately returns a HTTPClient::Connection instance as a result.
  #
  # source://httpclient//lib/httpclient.rb#924
  ...
  # It immediately returns a HTTPClient::Connection instance as a result.
  #
  # source://httpclient//lib/httpclient.rb#930
  ...
  #
  # source://httpclient//lib/httpclient.rb#487
  def proxy; end
  ...
  # Calling this method resets all existing sessions.
  #
  # source://httpclient//lib/httpclient.rb#501
  def proxy=(proxy); end

  # HTTPClient::ProxyAuth:: Proxy authentication handler.
  #
  # source://httpclient//lib/httpclient.rb#331
  def proxy_auth; end

  # Sends PUT request to the specified URL.  See request for arguments.
  #
  # source://httpclient//lib/httpclient.rb#774
  def put(uri, *args, &block); end

  # Sends PUT request in async style.  See request_async2 for arguments.
  # It immediately returns a HTTPClient::Connection instance as a result.
  #
  # source://httpclient//lib/httpclient.rb#901
  ...
  #
  # source://httpclient//lib/httpclient.rb#629
  ...
  #
  # source://httpclient//lib/httpclient.rb#847
  ...
  #
  # source://httpclient//lib/httpclient.rb#944
  ...
  #
  # source://httpclient//lib/httpclient.rb#950
  ...
  #
  # source://httpclient//lib/httpclient.rb#329
  ...
  #
  # source://httpclient//lib/httpclient.rb#966
  def reset(uri); end

  # Resets all of internal sessions.  Keep-alive connections are disconnected.
  #
  # source://httpclient//lib/httpclient.rb#972
  def reset_all; end
  ...
  #
  # source://httpclient//lib/httpclient.rb#610
  ...
  # Calling this method resets all existing sessions.
  #
  # source://httpclient//lib/httpclient.rb#566
  def set_auth(domain, user, passwd); end

  # Deprecated.  Use set_auth instead.
  #
  # source://httpclient//lib/httpclient.rb#573
  ...
  # Calling this method resets all existing sessions.
  #
  # source://httpclient//lib/httpclient.rb#602
  ...
  # Calling this method resets all existing sessions.
  #
  # source://httpclient//lib/httpclient.rb#584
  ...
  #
  # source://httpclient//lib/httpclient.rb#320
  def ssl_config; end
  ...
  #
  # source://httpclient//lib/httpclient.rb#706
  ...
  #
  # source://httpclient//lib/httpclient.rb#333
  def www_auth; end
  ...
  # source://httpclient//lib/httpclient.rb#1195
  def create_boundary; end

  # source://httpclient//lib/httpclient.rb#1150
  def create_request(method, uri, query, body, header); end

  # !! CAUTION !!
  #   Method 'do_get*' runs under MT conditon. Be careful to change.
  #
  # source://httpclient//lib/httpclient.rb#1234
  def do_get_block(req, proxy, conn, &block); end

  # source://httpclient//lib/httpclient.rb#1303
  def do_get_header(req, res, sess); end

  # source://httpclient//lib/httpclient.rb#1272
  def do_get_stream(req, proxy, conn); end

  # source://httpclient//lib/httpclient.rb#1003
  def do_request(method, uri, query, body, header, &block); end

  # source://httpclient//lib/httpclient.rb#1041
  def do_request_async(method, uri, query, body, header); end

  # source://httpclient//lib/httpclient.rb#1313
  ...
  #
  # source://httpclient//lib/httpclient.rb#1093
  def follow_redirect(method, uri, query, body, header, &block); end

  # source://httpclient//lib/httpclient.rb#1084
  def getenv(name); end

  # source://httpclient//lib/httpclient.rb#996
  def hashy_argument_has_keys(args, *key); end

  # source://httpclient//lib/httpclient.rb#1070
  def load_environment; end

  # @return [Boolean]
  #
  # source://httpclient//lib/httpclient.rb#1218
  def no_proxy?(uri); end

  # source://httpclient//lib/httpclient.rb#1204
  def override_header(header, key, value); end

  # source://httpclient//lib/httpclient.rb#1136
  def protect_keep_alive_disconnected; end

  # source://httpclient//lib/httpclient.rb#1320
  def set_encoding(str, encoding); end

  # source://httpclient//lib/httpclient.rb#1128
  def success_content(res); end

  # source://httpclient//lib/httpclient.rb#1324
  ...
  class << self
    ...
    # source://httpclient//lib/httpclient.rb#305
...
class HTTPClient::AuthBase
  ...
  #
  # source://httpclient//lib/httpclient/auth.rb#240
...
class HTTPClient::BadResponseError < ::RuntimeError
  ...
  #
  # source://httpclient//lib/httpclient.rb#258
  def initialize(msg, res = T.unsafe(nil)); end

  # HTTP::Message:: a response
  #
  # source://httpclient//lib/httpclient.rb#256
  def res; end
end
...
class HTTPClient::BasicAuth < ::HTTPClient::AuthBase
  ...
  #
  # source://httpclient//lib/httpclient/auth.rb#260
  def initialize; end

  # Challenge handler: remember URL for response.
  #
  # source://httpclient//lib/httpclient/auth.rb#303
  def challenge(uri, param_str = T.unsafe(nil)); end

  # Send Authorization Header without receiving 401
  #
  # source://httpclient//lib/httpclient/auth.rb#257
  def force_auth; end
  ...
  #
  # source://httpclient//lib/httpclient/auth.rb#289
  def get(req); end

  # Set authentication credential.
  # uri == nil for generic purpose (allow to use user/password for any URL).
  #
  # source://httpclient//lib/httpclient/auth.rb#269
  ...
  # @return [Boolean]
  #
  # source://httpclient//lib/httpclient/auth.rb#281
  def set?; end
end
...
class HTTPClient::Connection
  ...
  # @return [Boolean]
  #
  # source://httpclient//lib/httpclient/connection.rb#51
  def finished?; end

  # Waits the completion of the asynchronous invocation.
  #
  # source://httpclient//lib/httpclient/connection.rb#80
  def join; end
  ...
  #
  # source://httpclient//lib/httpclient/connection.rb#67
  def pop; end

  # source://httpclient//lib/httpclient/connection.rb#75
  def push(result); end
end
...
class HTTPClient::CookieManager
  ...
  # source://httpclient//lib/httpclient/cookie.rb#16
  def initialize(cookies_file = T.unsafe(nil), format = T.unsafe(nil), jar = T.unsafe(nil)); end

  # source://httpclient//lib/httpclient/cookie.rb#70
  def add(cookie); end

  # source://httpclient//lib/httpclient/cookie.rb#52
  def cookie_value(uri); end

  # source://httpclient//lib/httpclient/cookie.rb#34
  def cookies(uri = T.unsafe(nil)); end

  # source://httpclient//lib/httpclient/cookie.rb#63
  def cookies=(cookies); end

  # source://httpclient//lib/httpclient/cookie.rb#14
  def cookies_file; end

  # source://httpclient//lib/httpclient/cookie.rb#14
  def cookies_file=(_arg0); end

  # source://httpclient//lib/httpclient/cookie.rb#74
  def find(uri); end
  ...
  # source://httpclient//lib/httpclient/cookie.rb#23
  def load_cookies; end

  # source://httpclient//lib/httpclient/cookie.rb#59
  def parse(value, uri); end

  # source://httpclient//lib/httpclient/cookie.rb#29
  def save_cookies(session = T.unsafe(nil)); end

  private

  # source://httpclient//lib/httpclient/cookie.rb#83
  def check_cookies_file; end
end

# Default User-Agent header
#
# source://httpclient//lib/httpclient.rb#380
...
class HTTPClient::DigestAuth < ::HTTPClient::AuthBase
  ...
  #
  # source://httpclient//lib/httpclient/auth.rb#338
  def initialize; end

  # Challenge handler: remember URL and challenge token for response.
  #
  # source://httpclient//lib/httpclient/auth.rb#380
  ...
  # * child page of defined credential
  #
  # source://httpclient//lib/httpclient/auth.rb#364
  def get(req); end

  # Set authentication credential.
  # uri == nil is ignored.
  #
  # source://httpclient//lib/httpclient/auth.rb#346
  def set(uri, user, passwd); end
  ...
  # @return [Boolean]
  #
  # source://httpclient//lib/httpclient/auth.rb#356
  def set?; end
  ...
  #
  # source://httpclient//lib/httpclient/auth.rb#393
  def calc_cred(req, user, passwd, param); end

  # cf. WEBrick::HTTPAuth::DigestAuth#generate_next_nonce(aTime)
  #
  # source://httpclient//lib/httpclient/auth.rb#440
  def generate_cnonce; end

  # source://httpclient//lib/httpclient/auth.rb#446
...
class HTTPClient::KeepAliveDisconnected < ::StandardError
  ...
  #
  # source://httpclient//lib/httpclient.rb#989
...
# source://httpclient//lib/httpclient.rb#244
...
# source://httpclient//lib/httpclient.rb#1216
...
class HTTPClient::NegotiateAuth < ::HTTPClient::AuthBase
  ...
  #
  # source://httpclient//lib/httpclient/auth.rb#507
  def initialize(scheme = T.unsafe(nil)); end

  # Challenge handler: remember URL and challenge token for response.
  #
  # source://httpclient//lib/httpclient/auth.rb#576
  def challenge(uri, param_str); end

  # Response handler: returns credential.
  # See ruby/ntlm for negotiation state transition.
  #
  # source://httpclient//lib/httpclient/auth.rb#536
  def get(req); end

  # NTLM opt for ruby/ntlm.  {:ntlmv2 => true} by default.
  #
  # source://httpclient//lib/httpclient/auth.rb#504
  def ntlm_opt; end

  # Set authentication credential.
  # uri == nil for generic purpose (allow to use user/password for any URL).
  #
  # source://httpclient//lib/httpclient/auth.rb#518
  def set(uri, user, passwd); end
  ...
  # @return [Boolean]
  #
  # source://httpclient//lib/httpclient/auth.rb#530
  def set?; end
end
...
class HTTPClient::OAuth < ::HTTPClient::AuthBase
  ...
  #
  # source://httpclient//lib/httpclient/auth.rb#750
  def initialize; end
  ...
  #
  # source://httpclient//lib/httpclient/auth.rb#813
  def challenge(uri, param_str = T.unsafe(nil)); end

  # source://httpclient//lib/httpclient/auth.rb#745
  def escape(str); end
  ...
  # * child page of defined credential
  #
  # source://httpclient//lib/httpclient/auth.rb#794
  def get(req); end

  # Get authentication credential.
  #
  # source://httpclient//lib/httpclient/auth.rb#784
  def get_config(uri = T.unsafe(nil)); end

  # Set authentication credential.
  # You cannot set OAuth config via WWWAuth#set_auth. Use OAuth#config=
  #
  # source://httpclient//lib/httpclient/auth.rb#762
  def set(*args); end
  ...
  # @return [Boolean]
  #
  # source://httpclient//lib/httpclient/auth.rb#767
  def set?; end

  # Set authentication credential.
  #
  # source://httpclient//lib/httpclient/auth.rb#772
  def set_config(uri, config); end

  private

  # source://httpclient//lib/httpclient/auth.rb#837
  def calc_cred(req, config); end

  # source://httpclient//lib/httpclient/auth.rb#886
  def create_base_string(config, header, req); end

  # source://httpclient//lib/httpclient/auth.rb#826
  def do_get_config(uri = T.unsafe(nil)); end

  # source://httpclient//lib/httpclient/auth.rb#865
  def encode_header(k, v); end

  # source://httpclient//lib/httpclient/auth.rb#869
  def encode_param(params); end

  # source://httpclient//lib/httpclient/auth.rb#858
  def generate_nonce; end

  # source://httpclient//lib/httpclient/auth.rb#877
  def sign(config, header, req); end

  # source://httpclient//lib/httpclient/auth.rb#910
  def sign_hmac_sha1(config, base_string); end

  class << self
    # source://httpclient//lib/httpclient/auth.rb#733
    def escape(str); end
  end
end
...
class HTTPClient::OAuth::Config
  ...
  #
  # source://httpclient//lib/httpclient/auth.rb#687
  ...
  #
  # source://httpclient//lib/httpclient/auth.rb#701
  ...
  #
  # source://httpclient//lib/httpclient/auth.rb#686
  def realm; end
  ...
  #
  # source://httpclient//lib/httpclient/auth.rb#699
...
#
# source://httpclient//lib/httpclient.rb#377
...
class HTTPClient::ProxyBasicAuth < ::HTTPClient::BasicAuth
  # Challenge handler: remember URL for response.
  #
  # source://httpclient//lib/httpclient/auth.rb#326
  def challenge(uri, param_str = T.unsafe(nil)); end

  # source://httpclient//lib/httpclient/auth.rb#318
  def get(req); end

  # source://httpclient//lib/httpclient/auth.rb#312
  def set(uri, user, passwd); end
end
...
class HTTPClient::ProxyDigestAuth < ::HTTPClient::DigestAuth
  # source://httpclient//lib/httpclient/auth.rb#490
  def challenge(uri, param_str); end
  ...
  # before
  #
  # source://httpclient//lib/httpclient/auth.rb#474
  def get(req); end

  # source://httpclient//lib/httpclient/auth.rb#484
  def reset_challenge; end

  # overrides DigestAuth#set. sets default user name and password. uri is not used.
  #
  # source://httpclient//lib/httpclient/auth.rb#465
  def set(uri, user, passwd); end
end
...
class HTTPClient::RetryableResponse < ::StandardError
  ...
  #
  # source://httpclient//lib/httpclient.rb#979
  def res; end
end
...
class HTTPClient::SSLConfig
  ...
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#150
  ...
  # Calling this method resets all existing sessions.
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#275
  def add_crl(crl); end
  ...
  # Calling this method resets all existing sessions.
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#238
  def add_trust_ca(trust_ca_file_or_hashed_dir); end

  # source://httpclient//lib/httpclient/ssl_config.rb#248
  ...
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#138
  def cert_store; end
  ...
  # Calling this method resets all existing sessions.
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#209
  ...
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#345
  def default_verify_callback(is_ok, ctx); end

  # Loads default trust anchors.
  # Calling this method resets all existing sessions.
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#258
  ...
  # @raise [SSL::SSLError]
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#317
  def post_connection_check(peer_cert, hostname); end

  # Sample callback method:  CAUTION: does not check CRL/ARL.
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#365
  ...
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#180
  def set_client_cert_file(cert_file, key_file, pass = T.unsafe(nil)); end

  # interfaces for SSLSocket.
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#291
  ...
  # Calling this method resets all existing sessions.
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#198
  ...
  # @return [Boolean]
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#286
  def verify?; end
  ...
  # source://httpclient//lib/httpclient/ssl_config.rb#421
  def change_notify; end

  # Use 2048 bit certs trust anchor
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#427
...
#
# source://httpclient//lib/httpclient/ssl_config.rb#91
HTTPClient::SSLConfig::CIPHERS_DEFAULT = T.let(T.unsafe(nil), String)

# source://httpclient//lib/httpclient/ssl_config.rb#14
...
class HTTPClient::SSLSocket
  ...
  #
  # source://httpclient//lib/httpclient/ssl_socket.rb#34
  def initialize(socket, dest, config, opts = T.unsafe(nil)); end

  # source://httpclient//lib/httpclient/ssl_socket.rb#80
  def <<(str); end

  # source://httpclient//lib/httpclient/ssl_socket.rb#49
  def close; end

  # @return [Boolean]
  #
  # source://httpclient//lib/httpclient/ssl_socket.rb#54
  def closed?; end

  # @return [Boolean]
  #
  # source://httpclient//lib/httpclient/ssl_socket.rb#58
  def eof?; end

  # source://httpclient//lib/httpclient/ssl_socket.rb#86
  def flush; end

  # source://httpclient//lib/httpclient/ssl_socket.rb#62
  def gets(rs); end

  # source://httpclient//lib/httpclient/ssl_socket.rb#45
  def peer_cert; end

  # source://httpclient//lib/httpclient/ssl_socket.rb#68
  def read(size, buf = T.unsafe(nil)); end

  # source://httpclient//lib/httpclient/ssl_socket.rb#74
  def readpartial(size, buf = T.unsafe(nil)); end

  # source://httpclient//lib/httpclient/ssl_socket.rb#90
  def sync; end

  # source://httpclient//lib/httpclient/ssl_socket.rb#94
  def sync=(sync); end

  private

  # source://httpclient//lib/httpclient/ssl_socket.rb#129
  def check_mask(value, mask); end

  # source://httpclient//lib/httpclient/ssl_socket.rb#133
  def create_openssl_socket(socket); end

  # source://httpclient//lib/httpclient/ssl_socket.rb#146
  def debug(str); end

  # source://httpclient//lib/httpclient/ssl_socket.rb#114
  def post_connection_check(hostname); end

  # source://httpclient//lib/httpclient/ssl_socket.rb#100
  def ssl_connect(hostname = T.unsafe(nil)); end

  class << self
    # source://httpclient//lib/httpclient/ssl_socket.rb#17
...
class HTTPClient::SSPINegotiateAuth < ::HTTPClient::AuthBase
  ...
  #
  # source://httpclient//lib/httpclient/auth.rb#599
  def initialize; end

  # Challenge handler: remember URL and challenge token for response.
  #
  # source://httpclient//lib/httpclient/auth.rb#654
  def challenge(uri, param_str); end

  # Response handler: returns credential.
  # See win32/sspi for negotiation state transition.
  #
  # source://httpclient//lib/httpclient/auth.rb#617
  def get(req); end
  ...
  #
  # source://httpclient//lib/httpclient/auth.rb#606
  def set(*args); end
  ...
  # @return [Boolean]
  #
  # source://httpclient//lib/httpclient/auth.rb#611
  def set?; end
end
...
# source://httpclient//lib/httpclient.rb#286
...
module HTTPClient::Util
  ...
  #
  # source://httpclient//lib/httpclient/util.rb#133
  def argument_to_hash(args, *field); end

  # @return [Boolean]
  #
  # source://httpclient//lib/httpclient/util.rb#217
  def http?(uri); end
  ...
  # @return [Boolean]
  #
  # source://httpclient//lib/httpclient/util.rb#213
  def https?(uri); end
  ...
  #   end
  #
  # source://httpclient//lib/httpclient/util.rb#116
  def keyword_argument(args, *field); end

  # source://httpclient//lib/httpclient/util.rb#206
  ...
  #
  # source://httpclient//lib/httpclient/util.rb#184
  ...
  #
  # source://httpclient//lib/httpclient/util.rb#194
  def try_require(feature); end

  # Returns parent directory URI of the given URI.
  #
  # source://httpclient//lib/httpclient/util.rb#176
  ...
  #
  # source://httpclient//lib/httpclient/util.rb#167
  def uri_part_of(uri, part); end

  # Gets an URI instance.
  #
  # source://httpclient//lib/httpclient/util.rb#149
  def urify(uri); end
...
# source://httpclient//lib/httpclient/util.rb#91
HTTPClient::Util::AddressableEnabled = T.let(T.unsafe(nil), TrueClass)

class HTTPClient::Util::AddressableURI < ::Addressable::URI
  # source://httpclient//lib/httpclient/util.rb#66
  def authority; end

  # source://httpclient//lib/httpclient/util.rb#86
  def hostname; end

  # source://httpclient//lib/httpclient/util.rb#81
  def port; end
end
...
class HTTPClient::WebAgentSaver < ::HTTP::CookieJar::AbstractSaver
  # source://httpclient//lib/httpclient/cookie.rb#92
  def default_options; end

  # source://httpclient//lib/httpclient/cookie.rb#105
  def load(io, jar); end

  # source://httpclient//lib/httpclient/cookie.rb#97
  def save(io, jar); end

  private

  # source://httpclient//lib/httpclient/cookie.rb#113
  def cookie_to_record(cookie); end

  # source://httpclient//lib/httpclient/cookie.rb#125
  def parse_record(line); end

  class << self
    # source://httpclient//lib/httpclient/cookie.rb#158
    def flag(cookie); end

    # source://httpclient//lib/httpclient/cookie.rb#168
...
# source://httpclient//lib/httpclient/cookie.rb#156
...
class JSONClient < ::HTTPClient
  ...
  #
  # source://httpclient//lib/jsonclient.rb#15
  def initialize(*args); end
  ...
  #
  # source://httpclient//lib/jsonclient.rb#13
  def content_type_json_response_regex; end

  # source://httpclient//lib/jsonclient.rb#21
  def patch(uri, *args, &block); end

  # source://httpclient//lib/jsonclient.rb#25
  def post(uri, *args, &block); end

  # source://httpclient//lib/jsonclient.rb#29
  def put(uri, *args, &block); end

  # source://httpclient//lib/jsonclient.rb#33
  def request(method, uri, *args, &block); end

  private

  # source://httpclient//lib/jsonclient.rb#43
  def argument_to_hash_for_json(args); end

  # source://httpclient//lib/jsonclient.rb#52
  def json_header(header); end

  # source://httpclient//lib/jsonclient.rb#61
  def wrap_json_response(original); end
end

# source://httpclient//lib/jsonclient.rb#10
...
class WebAgent::Cookie < ::HTTP::Cookie
  ...
  #
  # source://httpclient//lib/httpclient/cookie.rb#200
  def domain; end

  # source://httpclient//lib/httpclient/cookie.rb#205
  def flag; end

  # @return [Boolean]
  #
  # source://httpclient//lib/httpclient/cookie.rb#193
  def http_only?; end

  # source://http-cookie/1.0.6/lib/http/cookie.rb#385
  def original_domain; end

  # Returns the value of attribute url.
  #
  # source://httpclient//lib/httpclient/cookie.rb#183
  def url; end
  ...
  #
  # source://httpclient//lib/httpclient/cookie.rb#188
  def url=(url); end

  private

  # source://httpclient//lib/httpclient/cookie.rb#212
  def deprecated(old, new); end
end

# source://httpclient//lib/httpclient/cookie.rb#178
