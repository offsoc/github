# -*- encoding: utf-8 -*-
# stub: opentelemetry-sdk 1.3.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/open-telemetry/opentelemetry-ruby/issues", "changelog_uri" => "https://open-telemetry.github.io/opentelemetry-ruby/opentelemetry-sdk/v1.3.0/file.CHANGELOG.html", "documentation_uri" => "https://open-telemetry.github.io/opentelemetry-ruby/opentelemetry-sdk/v1.3.0", "source_code_uri" => "https://github.com/open-telemetry/opentelemetry-ruby/tree/main/sdk" } if s.respond_to? :metadata=
  ...
  s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.51.0"])
