...
# Configuration for actionsworker deployment in Kubernetes. Loads after github-environment.rb.

require "resqued/metrics_server"
require "resqued/worker_readiness"

GitHub.role = :issueorchestrationworker
Aqueduct::Worker.configure do |config|
  config.worker_pool = "github-issueorchestrationworker"
end
...
BackgroundJobQueues.apply_dotcom(self, worker_role: :issueorchestrationworker, machine_type: :kube)
