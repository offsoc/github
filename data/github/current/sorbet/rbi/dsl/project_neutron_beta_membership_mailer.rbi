...
# This is an autogenerated file for dynamic methods in `ProjectNeutronBetaMembershipMailer`.
# Please instead update this file by running `bin/tapioca dsl ProjectNeutronBetaMembershipMailer`.

class ProjectNeutronBetaMembershipMailer
  class << self
    ...
    sig { params(membership: T.untyped).returns(::ActionMailer::MessageDelivery) }
    def waitlist_join(membership); end
  end
end
