...
#
# source://flipper//lib/flipper/middleware/setup_env.rb#1
module Flipper
  extend ::Flipper
  extend ::Forwardable
...
# source://flipper//lib/flipper/middleware/setup_env.rb#2
...
# source://flipper//lib/flipper/test/shared_adapter_test.rb#2
module Flipper::Test; end

# source://flipper//lib/flipper/test/shared_adapter_test.rb#3
module Flipper::Test::SharedAdapterTests
  # source://flipper//lib/flipper/test/shared_adapter_test.rb#4
  def setup; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#23
  def teardown; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#177
  def test_can_add_remove_and_list_known_features; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#206
  def test_can_clear_all_the_gate_values_for_a_feature; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#112
  def test_can_disable_percentage_of_actors_gate_many_times_and_consistently_return_values; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#138
  def test_can_disable_percentage_of_time_gate_many_times_and_consistently_return_values; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#272
  def test_can_double_enable_a_group_without_error; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#265
  def test_can_double_enable_an_actor_without_error; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#278
  def test_can_double_enable_percentage_without_error; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#283
  def test_can_double_enable_without_error; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#75
  def test_can_enable_disable_and_get_value_for_an_actor_gate; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#41
  def test_can_enable_disable_and_get_value_for_boolean_gate; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#120
  def test_can_enable_disable_and_get_value_for_percentage_of_time_gate; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#59
  def test_can_enable_disable_get_value_for_group_gate; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#94
  def test_can_enable_disable_get_value_for_percentage_of_actors_gate; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#104
  def test_can_enable_percentage_of_actors_gate_many_times_and_consistently_return_values; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#130
  def test_can_enable_percentage_of_time_gate_many_times_and_consistently_return_values; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#242
  def test_can_get_all_features; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#288
  def test_can_get_all_features_when_there_are_none; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#226
  def test_can_get_multiple_features; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#193
  def test_clears_all_the_gate_values_for_the_feature_on_remove; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#294
  def test_clears_other_gate_values_on_enable; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#146
  def test_converts_boolean_value_to_a_string; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#159
  def test_converts_group_value_to_a_string; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#171
  def test_converts_percentage_of_actors_integer_value_to_a_string; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#165
  def test_converts_percentage_of_time_integer_value_to_a_string; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#152
  def test_converts_the_actor_value_to_a_string; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#222
  def test_does_not_complain_clearing_a_feature_that_does_not_exist_in_adapter; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#48
  def test_fully_disables_all_enabled_things_when_boolean_gate_disabled; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#33
  def test_has_included_the_flipper_adapter_module; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#28
  def test_has_name_that_is_a_symbol; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#256
  def test_includes_explicitly_disabled_features_when_getting_all_features; end

  # source://flipper//lib/flipper/test/shared_adapter_test.rb#37
  def test_returns_correct_default_values_for_gates_if_none_are_enabled; end
end
