...
type AppStoreLink = {
  link: AppStoreButton['fields']['link']
  analyticsLabel: string
  analyticsLocation: string
}

export function GooglePlayStore({link, analyticsLabel, analyticsLocation}: AppStoreLink): JSX.Element {
  return (
    <Box className={styles.googleImageBox}>
      <a
        href={link.fields.href}
        aria-label={link.fields.text}
        target={link.fields.openInNewTab ? '_blank' : '_self'}
        rel="noreferrer"
        {...getAnalyticsEvent(
          {
        ...
        data-ref={`${analyticsLabel}-google-play-store-button-${link.sys.id}`}
      >
        <svg
          viewBox="0 0 135 40"
        ...
        >
          ...
          <path
            ...
            fillRule="nonzero"
          />
          <path d="M37.027 34.279l.094-.054-.094.054z" fill="url(#_Linear5)" transform="translate(-10 -10)" />
          <path
          ...
          <path
            ...
            transform="translate(-10 -10)"
          />
          <path d="M20.435 42.465v-.001l.074-.074-.074.075z" fill="url(#_Linear8)" transform="translate(-10 -10)" />
