...
#
# source://tilt//lib/tilt/creole.rb#7
class Tilt::CreoleTemplate < ::Tilt::Template
  # @return [Boolean]
  #
  # source://tilt//lib/tilt/creole.rb#21
  def allows_script?; end

  # source://tilt//lib/tilt/creole.rb#17
  def evaluate(scope, locals, &block); end

  # source://tilt//lib/tilt/creole.rb#8
  def prepare; end
end
...
class Tilt::PrawnTemplate < ::Tilt::Template
  # @return [Boolean]
  #
  # source://tilt//lib/tilt/prawn.rb#25
  def allows_script?; end

  # source://tilt//lib/tilt/prawn.rb#14
  def evaluate(scope, locals, &block); end

  # source://tilt//lib/tilt/prawn.rb#29
  def precompiled_template(locals); end
  ...
  # source://tilt//lib/tilt/prawn.rb#36
  def prawn_options; end
end
...
# http://redcloth.org/
#
# source://tilt//lib/tilt/redcloth.rb#7
class Tilt::RedClothTemplate < ::Tilt::Template
  # @return [Boolean]
  #
  # source://tilt//lib/tilt/redcloth.rb#18
  def allows_script?; end

  # source://tilt//lib/tilt/redcloth.rb#14
  def evaluate(scope, locals, &block); end

  # source://tilt//lib/tilt/redcloth.rb#8
  def prepare; end
end
...
# http://redcloth.org/
#
# source://tilt//lib/tilt/wikicloth.rb#7
class Tilt::WikiClothTemplate < ::Tilt::Template
  # @return [Boolean]
  #
  # source://tilt//lib/tilt/wikicloth.rb#18
  def allows_script?; end

  # source://tilt//lib/tilt/wikicloth.rb#14
  def evaluate(scope, locals, &block); end

  # source://tilt//lib/tilt/wikicloth.rb#8
  def prepare; end
end
...
class Tilt::YajlTemplate < ::Tilt::Template
  ...
  #
  # source://tilt//lib/tilt/yajl.rb#73
  ...
  # source://tilt//lib/tilt/yajl.rb#53
  def precompiled_preamble(locals); end

  # source://tilt//lib/tilt/yajl.rb#62
  def precompiled_template(locals); end

  # source://tilt//lib/tilt/yajl.rb#46
  def prepare; end
end
