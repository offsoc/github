...
# source: sigstore/sigstore_bundle.proto

require 'google/protobuf'

require_relative 'field_behavior_pb'
require_relative 'envelope_pb'
require_relative 'sigstore_common_pb'
require_relative 'sigstore_rekor_pb'
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("sigstore/sigstore_bundle.proto", :syntax => :proto3) do
