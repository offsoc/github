...
module SemanticLogger::Appender
  class << self
    ...
    #
    # source://semantic_logger//lib/semantic_logger/appender.rb#30
    ...
    #
    # source://semantic_logger//lib/semantic_logger/appender.rb#61
...
class SemanticLogger::Appender::Wrapper < ::SemanticLogger::Subscriber
  ...
  #
  # source://semantic_logger//lib/semantic_logger/appender/wrapper.rb#42
  ...
  #
  # source://semantic_logger//lib/semantic_logger/appender/wrapper.rb#58
  def log(log); end

  # Returns the value of attribute logger.
  #
  # source://semantic_logger//lib/semantic_logger/appender/wrapper.rb#8
  def logger; end
end
...
class SemanticLogger::Appenders < ::Concurrent::Array
  ...
  # source://semantic_logger//lib/semantic_logger/appenders.rb#11
  def add(**args, &block); end

  # source://semantic_logger//lib/semantic_logger/appenders.rb#47
  def close; end
  ...
  # @return [Boolean]
  #
  # source://semantic_logger//lib/semantic_logger/appenders.rb#25
  def console_output?; end

  # source://semantic_logger//lib/semantic_logger/appenders.rb#37
  def flush; end

  # source://semantic_logger//lib/semantic_logger/appenders.rb#29
  def log(log); end
  ...
  #
  # source://semantic_logger//lib/semantic_logger/appenders.rb#60
  def reopen; end
end
...
class SemanticLogger::Base
  ...
  #
  # source://semantic_logger//lib/semantic_logger/base.rb#357
  def measure_internal(level, index, message, params); end

  # For measuring methods and logging their duration.
  #
  # source://semantic_logger//lib/semantic_logger/base.rb#416
...
class SemanticLogger::DebugAsTraceLogger < ::SemanticLogger::Logger
  # source://semantic_logger//lib/semantic_logger/debug_as_trace_logger.rb#18
  def benchmark_debug(*args, &block); end

  # source://semantic_logger//lib/semantic_logger/debug_as_trace_logger.rb#6
  def debug(*args, &block); end

  # @return [Boolean]
  #
  # source://semantic_logger//lib/semantic_logger/debug_as_trace_logger.rb#10
  def debug?; end

  # source://semantic_logger//lib/semantic_logger/debug_as_trace_logger.rb#14
...
class SemanticLogger::Formatters::Signalfx < ::SemanticLogger::Formatters::Base
  ...
  #
  # source://semantic_logger//lib/semantic_logger/formatters/signalfx.rb#108
  ...
  #
  # source://semantic_logger//lib/semantic_logger/formatters/signalfx.rb#146
  def add_counter(counters, metric); end

  # source://semantic_logger//lib/semantic_logger/formatters/signalfx.rb#141
...
class SemanticLogger::Log
  ...
  #
  # source://semantic_logger//lib/semantic_logger/log.rb#189
  ...
  #
  # source://semantic_logger//lib/semantic_logger/log.rb#217
  def duration_human; end

  # source://semantic_logger//lib/semantic_logger/log.rb#209
  ...
  #
  # source://semantic_logger//lib/semantic_logger/log.rb#250
  ...
  #
  # source://semantic_logger//lib/semantic_logger/log.rb#257
  ...
  #
  # source://semantic_logger//lib/semantic_logger/log.rb#235
  def level_to_s; end
  ...
  # @return [Boolean]
  #
  # source://semantic_logger//lib/semantic_logger/log.rb#289
  def metric_only?; end
  ...
  # @return [Boolean]
  #
  # source://semantic_logger//lib/semantic_logger/log.rb#274
  def payload?; end
  ...
  # DEPRECATED
  #
  # source://semantic_logger//lib/semantic_logger/log.rb#240
  ...
  # source://semantic_logger//lib/semantic_logger/log.rb#278
  def to_h(host = T.unsafe(nil), application = T.unsafe(nil), environment = T.unsafe(nil)); end
end

# source://semantic_logger//lib/semantic_logger/log.rb#247
SemanticLogger::Log::CALLER_REGEXP = T.let(T.unsafe(nil), Regexp)

# source://semantic_logger//lib/semantic_logger/log.rb#165
...
# end
#
# source://semantic_logger//lib/semantic_logger/test/capture_log_events.rb#21
class SemanticLogger::Test::CaptureLogEvents < ::SemanticLogger::Subscriber
  ...
  #
  # source://semantic_logger//lib/semantic_logger/test/capture_log_events.rb#25
  def initialize(level: T.unsafe(nil), metrics: T.unsafe(nil)); end

  # source://semantic_logger//lib/semantic_logger/test/capture_log_events.rb#34
  def clear; end
  ...
  # source://semantic_logger//lib/semantic_logger/test/capture_log_events.rb#30
  def log(log); end
end
...
module SemanticLogger::Test::Minitest
  ...
  #
  # source://semantic_logger//lib/semantic_logger/test/minitest.rb#19
  def assert_semantic_logger_event(event, level: T.unsafe(nil), name: T.unsafe(nil), message: T.unsafe(nil), message_includes: T.unsafe(nil), payload: T.unsafe(nil), payload_includes: T.unsafe(nil), thread_name: T.unsafe(nil), tags: T.unsafe(nil), named_tags: T.unsafe(nil), context: T.unsafe(nil), metric: T.unsafe(nil), metric_amount: T.unsafe(nil), dimensions: T.unsafe(nil)); end

  # Returns [Array<SemanticLogger::Log>] the log events from Semantic Logger
  # captured whilst executing the supplied block.
  #
  # source://semantic_logger//lib/semantic_logger/test/minitest.rb#6
  def semantic_logger_events(klass = T.unsafe(nil), &block); end
end
