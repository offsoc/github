...
# Configuration for pullrequestworker deployment in Kubernetes. Loads after github-environment.rb.

require "resqued/metrics_server"
require "resqued/worker_readiness"

GitHub.role = :pullrequestworker
Aqueduct::Worker.configure do |config|
  config.worker_pool = "github-pullrequestworker"
end
...
T.unsafe(self).worker_pool ENV.fetch("RESQUED_WORKER_POOL_SIZE", 12).to_i, shuffle_queues: true

BackgroundJobQueues.apply_dotcom(self, worker_role: :pullrequestworker, machine_type: :kube)
