...
# This is an autogenerated file for dynamic methods in `Proto::TrustMetadataApi::V0::ListAttestationsByRepositoryResponse`.
# Please instead update this file by running `bin/tapioca dsl Proto::TrustMetadataApi::V0::ListAttestationsByRepositoryResponse`.
