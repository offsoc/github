...
# This is an autogenerated file for dynamic methods in `DetachRepositoryOrchestration`.
# Please instead update this file by running `bin/tapioca dsl DetachRepositoryOrchestration`.

class DetachRepositoryOrchestration
  ...
  module CommonRelationMethods
    sig do
      params(
        block: T.nilable(T.proc.params(record: ::DetachRepositoryOrchestration).returns(T.untyped))
      ).returns(T::Boolean)
    end
    def any?(&block); end
    ...
    sig do
      params(
        ...
        block: T.nilable(T.proc.params(object: ::DetachRepositoryOrchestration).void)
      ).returns(::DetachRepositoryOrchestration)
    end
    ...
    sig { returns(T::Array[::DetachRepositoryOrchestration]) }
    def destroy_all; end

    sig { params(conditions: T.untyped).returns(T::Boolean) }
    def exists?(conditions = :none); end

    sig { returns(T.nilable(::DetachRepositoryOrchestration)) }
    def fifth; end

    sig { returns(::DetachRepositoryOrchestration) }
    def fifth!; end

    sig { params(args: T.untyped).returns(T.untyped) }
    def find(*args); end

    sig { params(args: T.untyped).returns(T.nilable(::DetachRepositoryOrchestration)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::DetachRepositoryOrchestration) }
    def find_by!(*args); end
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::DetachRepositoryOrchestration).void)
      ).returns(T.nilable(T::Enumerator[::DetachRepositoryOrchestration]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::DetachRepositoryOrchestration]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::DetachRepositoryOrchestration]]))
    end
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::DetachRepositoryOrchestration)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::DetachRepositoryOrchestration) }
    def find_signed!(signed_id, purpose: nil); end

    sig { params(arg: T.untyped, args: T.untyped).returns(::DetachRepositoryOrchestration) }
  ...
  class PrivateAssociationRelation < ::ActiveRecord::AssociationRelation
    ...
    Elem = type_member { { fixed: ::DetachRepositoryOrchestration } }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::DetachRepositoryOrchestration, T::Enumerable[T.any(::DetachRepositoryOrchestration, T::Enumerable[::DetachRepositoryOrchestration])])
    ...
    sig do
      params(
        other_array: T.any(::DetachRepositoryOrchestration, T::Enumerable[T.any(::DetachRepositoryOrchestration, T::Enumerable[::DetachRepositoryOrchestration])])
      ).returns(T::Array[::DetachRepositoryOrchestration])
    end
