...
# source://will_paginate//lib/will_paginate/array.rb#3
class Array
  include ::Prelude::Enumerator
  include ::Enumerable
  ...
  #
  # source://will_paginate//lib/will_paginate/array.rb#24
...
# You will paginate!
#
# source://will_paginate//lib/will_paginate/page_number.rb#3
module WillPaginate
  extend ::WillPaginate::PerPage
...
# source://will_paginate//lib/will_paginate/view_helpers/sinatra.rb#6
module WillPaginate::Sinatra
  class << self
    # source://will_paginate//lib/will_paginate/view_helpers/sinatra.rb#35
    def registered(app); end
  end
end

# source://will_paginate//lib/will_paginate/view_helpers/sinatra.rb#7
module WillPaginate::Sinatra::Helpers
  include ::WillPaginate::I18n
  include ::WillPaginate::ViewHelpers

  # source://will_paginate//lib/will_paginate/view_helpers/sinatra.rb#10
  def will_paginate(collection, options = T.unsafe(nil)); end
end

# source://will_paginate//lib/will_paginate/view_helpers/sinatra.rb#16
class WillPaginate::Sinatra::LinkRenderer < ::WillPaginate::ViewHelpers::LinkRenderer
  protected

  # source://will_paginate//lib/will_paginate/view_helpers/sinatra.rb#30
  def build_query(params); end

  # source://will_paginate//lib/will_paginate/view_helpers/sinatra.rb#26
  def request; end

  # source://will_paginate//lib/will_paginate/view_helpers/sinatra.rb#19
  def url(page); end
end
