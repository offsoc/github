...
# Configuration for accountsecurityworker deployment in Kubernetes. Loads after github-environment.rb.

require "resqued/metrics_server"
require "resqued/worker_readiness"

GitHub.role = :accountsecurityworker
Aqueduct::Worker.configure do |config|
  config.worker_pool = "github-accountsecurityworker"
end
...
BackgroundJobQueues.apply_dotcom(self, worker_role: :accountsecurityworker, machine_type: :kube)
