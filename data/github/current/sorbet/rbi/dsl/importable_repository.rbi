  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::ImportableRepository).void)
      ).returns(T.nilable(T::Enumerator[::ImportableRepository]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::ImportableRepository]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::ImportableRepository]]))
    end
