  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::IntegrationAlias).void)
      ).returns(T.nilable(T::Enumerator[::IntegrationAlias]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::IntegrationAlias]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::IntegrationAlias]]))
    end
