...
class Sawyer::Agent
  ...
  #
  # source://sawyer//lib/sawyer/agent.rb#85
  ...
  #
  # source://sawyer//lib/sawyer/agent.rb#124
  ...
  # Returns a String.
  #
  # source://sawyer//lib/sawyer/agent.rb#115
  def encode_body(data); end

  # source://sawyer//lib/sawyer/agent.rb#132
  def expand_url(url, options = T.unsafe(nil)); end

  # source://sawyer//lib/sawyer/agent.rb#141
  def inspect; end
  ...
  # source://sawyer//lib/sawyer/agent.rb#150
  def marshal_dump; end

  # source://sawyer//lib/sawyer/agent.rb#154
  def marshal_load(dumped); end

  # source://sawyer//lib/sawyer/agent.rb#128
  ...
  #
  # source://sawyer//lib/sawyer/agent.rb#54
  def rels; end
  ...
  # Returns a Sawyer::Response.
  #
  # source://sawyer//lib/sawyer/agent.rb#61
  def root; end
  ...
  # Returns a Sawyer::Response.
  #
  # source://sawyer//lib/sawyer/agent.rb#68
  def start; end
...
class Sawyer::Relation
  ...
  # source://octokit/4.20.0/lib/ext/sawyer/relation.rb#4
...
# source://sawyer//lib/sawyer/resource.rb#2
class Sawyer::Resource
  ...
  #
  # source://sawyer//lib/sawyer/resource.rb#12
  ...
  #
  # source://sawyer//lib/sawyer/resource.rb#54
  def [](method); end
  ...
  # Returns - value
  #
  # source://sawyer//lib/sawyer/resource.rb#66
  ...
  # source://sawyer//lib/sawyer/resource.rb#122
  def each(&block); end

  # source://sawyer//lib/sawyer/resource.rb#118
  def inspect; end
  ...
  # @return [Boolean]
  #
  # source://sawyer//lib/sawyer/resource.rb#45
  def key?(key); end

  # source://sawyer//lib/sawyer/resource.rb#146
  def marshal_dump; end

  # source://sawyer//lib/sawyer/resource.rb#150
  def marshal_load(dumped); end

  # Provides access to a resource's attributes.
  #
  # source://sawyer//lib/sawyer/resource.rb#76
  ...
  #
  # source://sawyer//lib/sawyer/resource.rb#32
  def process_value(value); end

  # source://sawyer//lib/sawyer/resource.rb#131
  def to_attrs; end
  ...
  class << self
    ...
    #
    # source://sawyer//lib/sawyer/resource.rb#100
    def attr_accessor(*attrs); end
  end
end

# source://sawyer//lib/sawyer/resource.rb#73
Sawyer::Resource::ATTR_PREDICATE = T.let(T.unsafe(nil), String)

# source://sawyer//lib/sawyer/resource.rb#72
Sawyer::Resource::ATTR_SETTER = T.let(T.unsafe(nil), String)

# source://sawyer//lib/sawyer/resource.rb#3
