  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::EnterpriseOwner).void)
      ).returns(T.nilable(T::Enumerator[::EnterpriseOwner]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::EnterpriseOwner]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::EnterpriseOwner]]))
    end
