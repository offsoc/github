# -*- encoding: utf-8 -*-
# stub: opentelemetry-exporter-otlp 0.26.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/open-telemetry/opentelemetry-ruby/issues", "changelog_uri" => "https://open-telemetry.github.io/opentelemetry-ruby/opentelemetry-exporter-otlp/v0.26.0/file.CHANGELOG.html", "documentation_uri" => "https://open-telemetry.github.io/opentelemetry-ruby/opentelemetry-exporter-otlp/v0.26.0", "source_code_uri" => "https://github.com/open-telemetry/opentelemetry-ruby/tree/main/exporter/otlp" } if s.respond_to? :metadata=
  ...
  s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.3"])
