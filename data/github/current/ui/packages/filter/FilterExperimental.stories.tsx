...
const meta = {
  ...
  parameters: {
    ...
    enabledFeatures: ['filter_prefetch_suggestions'],
  },
  argTypes: {
    settings: {
      control: {type: 'object'},
...
export const ExperimentalFeatures = (props: FilterProps) => {
  const [filterValue, setFilterValue] = useState(
    '(state:open AND (is:issue OR is:pr)) AND (label:triage AND milestone:"invalid label")',
  )
...
ExperimentalFeatures.args = defaultArgs
