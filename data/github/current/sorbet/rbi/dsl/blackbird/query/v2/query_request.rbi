...
# This is an autogenerated file for dynamic methods in `Blackbird::Query::V2::QueryRequest`.
# Please instead update this file by running `bin/tapioca dsl Blackbird::Query::V2::QueryRequest`.
...
class Blackbird::Query::V2::QueryRequest
  sig do
    params(
      ...
      experiment_ids: T.nilable(T.any(Google::Protobuf::RepeatedField[Integer], T::Array[Integer])),
  ...
  def experiment_ids; end

  sig { params(value: Google::Protobuf::RepeatedField[Integer]).void }
  def experiment_ids=(value); end
