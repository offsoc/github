...
# This is an autogenerated file for types exported from the `github-proto-octocat` gem.
# Please instead update this file by running `bin/tapioca gem github-proto-octocat`.

# source://github-proto-octocat//lib/github/proto/octocat/version.rb#3
module GitHub
...
# source://github-proto-octocat//lib/github/proto/octocat/version.rb#4
module GitHub::Proto; end

# source://github-proto-octocat//lib/github/proto/octocat/version.rb#5
module GitHub::Proto::Octocat; end

# source://github-proto-octocat//lib/github-proto-octocat.rb#12
class GitHub::Proto::Octocat::Error < ::StandardError; end

# source://github-proto-octocat//lib/github/proto/octocat/v1/octocat_api_pb.rb#20
module GitHub::Proto::Octocat::V1; end
...
# source://github-proto-octocat//lib/github/proto/octocat/v1/octocat_api_twirp.rb#15
class GitHub::Proto::Octocat::V1::OctocatAPIClient < ::Twirp::Client
  # source://twirp/1.10.0/lib/twirp/client.rb#42
  def get_octocat(input, req_opts = T.unsafe(nil)); end
end

# source://github-proto-octocat//lib/github/proto/octocat/v1/octocat_api_twirp.rb#9
class GitHub::Proto::Octocat::V1::OctocatAPIService < ::Twirp::Service; end

# source://github-proto-octocat//lib/github/proto/octocat/version.rb#6
GitHub::Proto::Octocat::VERSION = T.let(T.unsafe(nil), String)
