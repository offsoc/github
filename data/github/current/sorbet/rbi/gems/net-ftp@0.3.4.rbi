...
class Net::FTP < ::Net::Protocol
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#1259
  def abort; end
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#911
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#1373
  def close; end
  ...
  # @return [Boolean]
  #
  # source://net-ftp//lib/net/ftp.rb#1389
  def closed?; end
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#393
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#1464
  def debug_print(msg); end

  # Deletes a file on the server.
  #
  # source://net-ftp//lib/net/ftp.rb#1166
  def delete(filename); end

  # Returns an array of file information in the directory (the output is like
  # `ls -l`).  If a block is given, it iterates through the listing.
  #
  # source://net-ftp//lib/net/ftp.rb#935
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#1339
  def features; end

  # Retrieves +remotefile+ in whatever mode the session is set (text or
  # binary).  See #gettextfile and #getbinaryfile.
  #
  # source://net-ftp//lib/net/ftp.rb#840
  ...
  # line at a time.
  #
  # source://net-ftp//lib/net/ftp.rb#814
  def gettextfile(remotefile, localfile = T.unsafe(nil), &block); end

  # Issues the HELP command.
  #
  # source://net-ftp//lib/net/ftp.rb#1302
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#626
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#1292
  def mdtm(filename); end

  # Creates a remote directory.
  #
  # source://net-ftp//lib/net/ftp.rb#1224
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#1140
  ...
  # If +pathname+ is omitted, the current directory is assumed.
  #
  # source://net-ftp//lib/net/ftp.rb#1118
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#919
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#1322
  def noop; end
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#1362
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#896
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#854
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#883
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#1313
  def quit; end
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#1155
  ...
  # (such as "RETR myfile").
  #
  # source://net-ftp//lib/net/ftp.rb#657
  ...
  # (such as "RETR myfile").
  #
  # source://net-ftp//lib/net/ftp.rb#682
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#1232
  def rmdir(dirname); end

  # Sends a command and returns the response.
  #
  # source://net-ftp//lib/net/ftp.rb#514
  def sendcmd(cmd); end
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#423
  def set_socket(sock, get_greeting = T.unsafe(nil)); end

  # Issues a SITE command.
  #
  # source://net-ftp//lib/net/ftp.rb#1329
  def site(arg); end

  # Returns the size of the given (remote) filename.
  #
  # source://net-ftp//lib/net/ftp.rb#1203
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#1276
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#707
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#743
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#524
  def voidcmd(cmd); end
  ...
  # FTPProtoError
  #
  # source://net-ftp//lib/net/ftp.rb#483
  def getresp; end

  # sends the appropriate command to enable a passive connection
  #
  # source://net-ftp//lib/net/ftp.rb#552
  def makepasv; end

  # Constructs a TCPServer socket
  #
  # source://net-ftp//lib/net/ftp.rb#546
  def makeport; end
  ...
  # Returns host and port.
  #
  # source://net-ftp//lib/net/ftp.rb#1437
  ...
  # Returns host and port.
  #
  # source://net-ftp//lib/net/ftp.rb#1453
  def parse257(resp); end

  # source://net-ftp//lib/net/ftp.rb#1098
  def parse_mlsx_entry(entry); end

  # source://net-ftp//lib/net/ftp.rb#1414
  def parse_pasv_ipv4_host(s); end

  # source://net-ftp//lib/net/ftp.rb#1419
  def parse_pasv_ipv6_host(s); end

  # source://net-ftp//lib/net/ftp.rb#1426
  def parse_pasv_port(s); end

  # Ensures that +line+ has a control return / line feed (CRLF) and writes
  # it to the socket.
  #
  # source://net-ftp//lib/net/ftp.rb#445
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#434
  def sanitize(s); end
  ...
  # equal 2.
  #
  # source://net-ftp//lib/net/ftp.rb#503
  def voidresp; end
...
# source://net-ftp//lib/net/ftp.rb#1521
class Net::FTP::BufferedSSLSocket < ::Net::FTP::BufferedSocket
  # @return [BufferedSSLSocket] a new instance of BufferedSSLSocket
  #
  # source://net-ftp//lib/net/ftp.rb#1522
  def initialize(*args, **options); end

  # source://net-ftp//lib/net/ftp.rb#1534
  def send(mesg, flags, dest = T.unsafe(nil)); end

  # source://net-ftp//lib/net/ftp.rb#1527
  def shutdown(*args); end

  private

  # source://net-ftp//lib/net/ftp.rb#1541
  def rbuf_fill; end
end

# source://net-ftp//lib/net/ftp.rb#1485
class Net::FTP::BufferedSocket < ::Net::BufferedIO
  # source://net-ftp//lib/net/ftp.rb#1487
  def addr(*args); end

  # source://net-ftp//lib/net/ftp.rb#1506
  def gets; end
  ...
  # source://net-ftp//lib/net/ftp.rb#1492
...
# and the pathname.
#
# source://net-ftp//lib/net/ftp.rb#957
class Net::FTP::MLSxEntry
  ...
  # @return [Boolean]
  #
  # source://net-ftp//lib/net/ftp.rb#996
  def appendable?; end

  # source://net-ftp//lib/net/ftp.rb#968
  def charset; end
  ...
  # @return [Boolean]
  #
  # source://net-ftp//lib/net/ftp.rb#1004
  def creatable?; end
  ...
  # @return [Boolean]
  #
  # source://net-ftp//lib/net/ftp.rb#1011
  def deletable?; end
  ...
  # @return [Boolean]
  #
  # source://net-ftp//lib/net/ftp.rb#985
  def directory?; end
  ...
  # @return [Boolean]
  #
  # source://net-ftp//lib/net/ftp.rb#1041
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#958
  def facts; end
  ...
  # @return [Boolean]
  #
  # source://net-ftp//lib/net/ftp.rb#977
  def file?; end
  ...
  # @return [Boolean]
  #
  # source://net-ftp//lib/net/ftp.rb#1033
  def listable?; end
  ...
  # @return [Boolean]
  #
  # source://net-ftp//lib/net/ftp.rb#1049
  def purgeable?; end
  ...
  # @return [Boolean]
  #
  # source://net-ftp//lib/net/ftp.rb#1056
  def readable?; end
...
# :stopdoc:
#
# source://net-ftp//lib/net/ftp.rb#1469
class Net::FTP::NullSocket
  ...
  # source://net-ftp//lib/net/ftp.rb#1470
  def read_timeout=(sec); end
end
