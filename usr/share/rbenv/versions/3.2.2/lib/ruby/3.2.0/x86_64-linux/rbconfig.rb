...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/usr/share/rbenv/versions/3.2.2")
  ...
  CONFIG["configure_args"] = " '--prefix=/usr/share/rbenv/versions/3.2.2' '--with-jemalloc' '--disable-install-rdoc' 'CFLAGS=-g -O2 -fdebug-prefix-map=/tmp/brew2deb/packages/ruby=. -fstack-protector-strong -Wformat -Werror=format-security' 'LDFLAGS=-Wl,-Bsymbolic-functions -Wl,-z,relro' 'CPPFLAGS=-Wdate-time -D_FORTIFY_SOURCE=2' 'CXXFLAGS=-g -O2 -fdebug-prefix-map=/tmp/brew2deb/packages/ruby=. -fstack-protector-strong -Wformat -Werror=format-security'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/usr/share/rbenv/versions/3.2.2"
  ...
  CONFIG["COMMON_LIBS"] = ""
  CONFIG["MAINLIBS"] = "-lz -lrt -lrt -ljemalloc -lgmp -ldl -lcrypt -lm -lpthread "
  CONFIG["ENABLE_SHARED"] = "no"
  CONFIG["DLDSHARED"] = "$(CC) -shared"
  CONFIG["DLDLIBS"] = "-ljemalloc -lc"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-Wl,-Bsymbolic-functions -Wl,-z,relro -Wl,--compress-debug-sections=zlib"
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["GCC"] = "yes"
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-g -O2 -fdebug-prefix-map=/tmp/brew2deb/packages/ruby=. -fstack-protector-strong -Wformat -Werror=format-security"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-Wdate-time -D_FORTIFY_SOURCE=2 $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -Wl,-Bsymbolic-functions -Wl,-z,relro -fstack-protector-strong -rdynamic -Wl,-export-dynamic"
  CONFIG["CFLAGS"] = "-g -O2 -fdebug-prefix-map=/tmp/brew2deb/packages/ruby=. -fstack-protector-strong -Wformat -Werror=format-security"
