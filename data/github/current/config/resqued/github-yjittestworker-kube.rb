...
# Configuration for rafrdzworker deployment in Kubernetes. Loads after github-environment.rb.

require "resqued/metrics_server"
require "resqued/worker_readiness"

## Keeping as test worker role, but configuring at github-lowworker for YJIT Testing

GitHub.role = :yjittestworker
Aqueduct::Worker.configure do |config|
  config.worker_pool = "github-yjittestworker-kube"
end
