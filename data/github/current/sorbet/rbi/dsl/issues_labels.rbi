  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::IssuesLabels).void)
      ).returns(T.nilable(T::Enumerator[::IssuesLabels]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::IssuesLabels]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::IssuesLabels]]))
    end
