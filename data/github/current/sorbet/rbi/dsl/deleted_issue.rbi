  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::DeletedIssue).void)
      ).returns(T.nilable(T::Enumerator[::DeletedIssue]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::DeletedIssue]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::DeletedIssue]]))
    end
