...
class Google::Auth::Credentials
  ...
  #
  # source://googleauth//lib/googleauth/credentials.rb#483
  ...
  # source://googleauth//lib/googleauth/credentials.rb#525
  def update_from_hash(hash, options); end

  # source://googleauth//lib/googleauth/credentials.rb#519
  def update_from_signet(client); end

  # Verify that the keyfile argument is a file.
  #
  # source://googleauth//lib/googleauth/credentials.rb#477
  def verify_keyfile_exists!(keyfile); end

  # Verify that the keyfile argument is provided.
  #
  # source://googleauth//lib/googleauth/credentials.rb#471
  ...
  class << self
    ...
    # @return [Credentials]
    #
    # source://googleauth//lib/googleauth/credentials.rb#393
    ...
    #
    # source://googleauth//lib/googleauth/credentials.rb#426
    def from_default_paths(options); end

    # @private Lookup Credentials from environment variables.
    #
    # source://googleauth//lib/googleauth/credentials.rb#407
...
class Google::Auth::GCECredentials < ::Signet::OAuth2::Client
  ...
  class << self
    ...
    # source://googleauth//lib/googleauth/compute_engine.rb#64
    def compute_id_token_uri; end

    # source://googleauth//lib/googleauth/compute_engine.rb#52
    ...
    # @return [Boolean]
    #
    # source://googleauth//lib/googleauth/compute_engine.rb#70
    def on_gce?(options = T.unsafe(nil), reload = T.unsafe(nil)); end
...
class Google::Auth::UserAuthorizer
  ...
  #
  # source://googleauth//lib/googleauth/user_authorizer.rb#189
  ...
  #
  # source://googleauth//lib/googleauth/user_authorizer.rb#87
  ...
  #
  # source://googleauth//lib/googleauth/user_authorizer.rb#114
  ...
  # @return [Google::Auth::UserRefreshCredentials] Credentials if exchange is successful
  #
  # source://googleauth//lib/googleauth/user_authorizer.rb#155
  ...
  # @param user_id [String] Unique ID of the user for loading/storing credentials.
  #
  # source://googleauth//lib/googleauth/user_authorizer.rb#199
  ...
  #
  # source://googleauth//lib/googleauth/user_authorizer.rb#219
  ...
  #
  # source://googleauth//lib/googleauth/user_authorizer.rb#238
  ...
  # @return [Boolean]
  #
  # source://googleauth//lib/googleauth/user_authorizer.rb#272
...
class Signet::OAuth2::Client
  ...
  # source://googleauth//lib/googleauth/signet.rb#40
  def fetch_access_token!(options = T.unsafe(nil)); end
  ...
  # source://googleauth//lib/googleauth/signet.rb#62
  ...
  #
  # source://googleauth//lib/googleauth/signet.rb#35
  def token_type; end
