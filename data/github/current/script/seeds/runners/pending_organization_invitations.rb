...
module Seeds
  class Runner
    class PendingOrganizationInvitations < Seeds::Runner


      def self.help
        <<~EOF
        Adds pending organization invitations to an organization. Defaults to 50 invitations in the github organization.
        EOF
      end
      ...
      def self.run(options = {})
        ...
        invite_number.times do |i|
          invitee = Seeds::Objects::User.create(login: "pending-user-#{i}")
