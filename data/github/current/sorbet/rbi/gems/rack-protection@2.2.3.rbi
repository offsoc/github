...
# source://rack-protection//lib/rack/protection/version.rb#1
module Rack
  class << self
...
# source://rack-protection//lib/rack/protection/version.rb#2
module Rack::Protection
  class << self
    # source://rack-protection//lib/rack/protection.rb#24
...
#
# source://rack-protection//lib/rack/protection/authenticity_token.rb#92
class Rack::Protection::AuthenticityToken < ::Rack::Protection::Base
  # @return [Boolean]
  #
  # source://rack-protection//lib/rack/protection/authenticity_token.rb#107
  def accepts?(env); end

  # source://rack-protection//lib/rack/protection/base.rb#22
  def default_options; end

  # source://rack-protection//lib/rack/protection/authenticity_token.rb#119
  def mask_authenticity_token(session, path: T.unsafe(nil), method: T.unsafe(nil)); end

  private

  # source://rack-protection//lib/rack/protection/authenticity_token.rb#201
  def compare_with_global_token(token, session); end

  # source://rack-protection//lib/rack/protection/authenticity_token.rb#205
  def compare_with_per_form_token(token, session, request); end

  # source://rack-protection//lib/rack/protection/authenticity_token.rb#197
  ...
  # like BREACH.
  #
  # source://rack-protection//lib/rack/protection/authenticity_token.rb#172
  def mask_token(token); end

  # @return [Boolean]
  #
  # source://rack-protection//lib/rack/protection/authenticity_token.rb#193
  ...
  #
  # source://rack-protection//lib/rack/protection/authenticity_token.rb#180
  def unmask_token(masked_token); end

  # @return [Boolean]
  #
  # source://rack-protection//lib/rack/protection/authenticity_token.rb#189
  ...
  # source://rack-protection//lib/rack/protection/authenticity_token.rb#239
  def xor_byte_strings(s1, s2); end

  class << self
    # source://rack-protection//lib/rack/protection/authenticity_token.rb#103
...
# source://rack-protection//lib/rack/protection/authenticity_token.rb#131
Rack::Protection::AuthenticityToken::GLOBAL_TOKEN_IDENTIFIER = T.let(T.unsafe(nil), String)

# source://rack-protection//lib/rack/protection/authenticity_token.rb#93
Rack::Protection::AuthenticityToken::TOKEN_LENGTH = T.let(T.unsafe(nil), Integer)

# source://rack-protection//lib/rack/protection/base.rb#9
class Rack::Protection::Base
  # @return [Base] a new instance of Base
  #
  # source://rack-protection//lib/rack/protection/base.rb#33
  def initialize(app, options = T.unsafe(nil)); end

  # @raise [NotImplementedError]
  # @return [Boolean]
  #
  # source://rack-protection//lib/rack/protection/base.rb#41
  def accepts?(env); end

  # Returns the value of attribute app.
  #
  # source://rack-protection//lib/rack/protection/base.rb#19
  def app; end

  # source://rack-protection//lib/rack/protection/base.rb#45
  def call(env); end

  # source://rack-protection//lib/rack/protection/base.rb#29
  def default_options; end

  # source://rack-protection//lib/rack/protection/base.rb#70
  ...
  # source://rack-protection//lib/rack/protection/base.rb#110
  ...
  # source://rack-protection//lib/rack/protection/base.rb#64
  ...
  # source://rack-protection//lib/rack/protection/base.rb#100
  def origin(env); end

  # source://rack-protection//lib/rack/protection/base.rb#104
  def random_string(secure = T.unsafe(nil)); end

  # source://rack-protection//lib/rack/protection/base.rb#53
  def react(env); end

  # source://rack-protection//lib/rack/protection/base.rb#93
  ...
  # @return [Boolean]
  #
  # source://rack-protection//lib/rack/protection/base.rb#37
  def safe?(env); end

  # source://rack-protection//lib/rack/protection/base.rb#114
  def secure_compare(a, b); end

  # source://rack-protection//lib/rack/protection/base.rb#84
  def session(env); end
  ...
  # source://rack-protection//lib/rack/protection/base.rb#58
  ...
  class << self
    ...
    # source://rack-protection//lib/rack/protection/base.rb#25
    def default_reaction(reaction); end
  end
end

# source://rack-protection//lib/rack/protection/base.rb#10
...
#
# source://rack-protection//lib/rack/protection/content_security_policy.rb#38
class Rack::Protection::ContentSecurityPolicy < ::Rack::Protection::Base
  # source://rack-protection//lib/rack/protection/content_security_policy.rb#71
  def call(env); end

  # source://rack-protection//lib/rack/protection/content_security_policy.rb#52
  def csp_policy; end
...
# source://rack-protection//lib/rack/protection/content_security_policy.rb#41
Rack::Protection::ContentSecurityPolicy::DIRECTIVES = T.let(T.unsafe(nil), Array)

# source://rack-protection//lib/rack/protection/content_security_policy.rb#49
...
#
# source://rack-protection//lib/rack/protection/cookie_tossing.rb#17
class Rack::Protection::CookieTossing < ::Rack::Protection::Base
  # @return [Boolean]
  #
  # source://rack-protection//lib/rack/protection/cookie_tossing.rb#28
  def accepts?(env); end

  # source://rack-protection//lib/rack/protection/cookie_tossing.rb#55
  def bad_cookies; end

  # source://rack-protection//lib/rack/protection/cookie_tossing.rb#20
  def call(env); end

  # source://rack-protection//lib/rack/protection/cookie_tossing.rb#59
  def cookie_paths(path); end

  # source://rack-protection//lib/rack/protection/base.rb#70
  def default_reaction(env); end

  # source://rack-protection//lib/rack/protection/cookie_tossing.rb#66
  def empty_cookie(host, path); end

  # source://rack-protection//lib/rack/protection/cookie_tossing.rb#49
  def redirect(env); end

  # source://rack-protection//lib/rack/protection/cookie_tossing.rb#41
  def remove_bad_cookies(request, response); end

  # source://rack-protection//lib/rack/protection/cookie_tossing.rb#70
  def session_key; end
end
...
#
# source://rack-protection//lib/rack/protection/escaped_params.rb#24
class Rack::Protection::EscapedParams < ::Rack::Protection::Base
  extend ::Rack::Utils

  # @return [EscapedParams] a new instance of EscapedParams
  #
  # source://rack-protection//lib/rack/protection/escaped_params.rb#35
  def initialize(*_arg0); end

  # source://rack-protection//lib/rack/protection/escaped_params.rb#49
  def call(env); end

  # source://rack-protection//lib/rack/protection/base.rb#22
  def default_options; end

  # source://rack-protection//lib/rack/protection/escaped_params.rb#65
  def escape(object); end

  # source://rack-protection//lib/rack/protection/escaped_params.rb#75
  def escape_hash(hash); end

  # source://rack-protection//lib/rack/protection/escaped_params.rb#81
  def escape_string(str); end

  # source://rack-protection//lib/rack/protection/escaped_params.rb#59
  def handle(hash); end

  class << self
    # source://rack/2.2.8.1/lib/rack/utils.rb#184
    def escape_html(string); end

    private

    # source://rack/2.2.8.1/lib/rack/utils.rb#38
...
#
# source://rack-protection//lib/rack/protection/form_token.rb#17
class Rack::Protection::FormToken < ::Rack::Protection::AuthenticityToken
  # @return [Boolean]
  #
  # source://rack-protection//lib/rack/protection/form_token.rb#18
  def accepts?(env); end
end
...
#
# source://rack-protection//lib/rack/protection/frame_options.rb#19
class Rack::Protection::FrameOptions < ::Rack::Protection::Base
  # source://rack-protection//lib/rack/protection/frame_options.rb#30
  def call(env); end
...
#
# source://rack-protection//lib/rack/protection/http_origin.rb#19
class Rack::Protection::HttpOrigin < ::Rack::Protection::Base
  # @return [Boolean]
  #
  # source://rack-protection//lib/rack/protection/http_origin.rb#30
  def accepts?(env); end
...
# source://rack-protection//lib/rack/protection/http_origin.rb#20
...
#
# source://rack-protection//lib/rack/protection/ip_spoofing.rb#11
...
#
# source://rack-protection//lib/rack/protection/json_csrf.rb#19
class Rack::Protection::JsonCsrf < ::Rack::Protection::Base
  # source://rack-protection//lib/rack/protection/json_csrf.rb#24
  def call(env); end

  # source://rack-protection//lib/rack/protection/json_csrf.rb#52
  ...
  # @return [Boolean]
  #
  # source://rack-protection//lib/rack/protection/json_csrf.rb#37
  def has_vector?(request, headers); end

  # source://rack-protection//lib/rack/protection/base.rb#70
  def react(env); end

  # source://rack-protection//lib/rack/protection/json_csrf.rb#44
...
#
# source://rack-protection//lib/rack/protection/path_traversal.rb#12
class Rack::Protection::PathTraversal < ::Rack::Protection::Base
  # source://rack-protection//lib/rack/protection/path_traversal.rb#13
  def call(env); end

  # source://rack-protection//lib/rack/protection/path_traversal.rb#21
...
#
# source://rack-protection//lib/rack/protection/referrer_policy.rb#15
...
# a different host.
#
# source://rack-protection//lib/rack/protection/remote_referrer.rb#12
...
# Compatible with rack-csrf.
#
# source://rack-protection//lib/rack/protection/remote_token.rb#14
...
#
# source://rack-protection//lib/rack/protection/session_hijacking.rb#14
class Rack::Protection::SessionHijacking < ::Rack::Protection::Base
  # @return [Boolean]
  #
  # source://rack-protection//lib/rack/protection/session_hijacking.rb#19
  def accepts?(env); end
  ...
  # source://rack-protection//lib/rack/protection/session_hijacking.rb#30
  def encrypt(value); end
end
...
#
# source://rack-protection//lib/rack/protection/strict_transport.rb#20
class Rack::Protection::StrictTransport < ::Rack::Protection::Base
  # source://rack-protection//lib/rack/protection/strict_transport.rb#32
  def call(env); end
...
#
# source://rack-protection//lib/rack/protection/xss_header.rb#14
