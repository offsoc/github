...
class WebAuthn::FakeAuthenticator
  ...
  # source://webauthn//lib/webauthn/fake_authenticator.rb#50
  ...
  def make_credential(rp_id:, client_data_hash:, user_present: T.unsafe(nil), user_verified: T.unsafe(nil), backup_eligibility: T.unsafe(nil), backup_state: T.unsafe(nil), attested_credential_data: T.unsafe(nil), sign_count: T.unsafe(nil), extensions: T.unsafe(nil)); end

  private

  # Returns the value of attribute credentials.
  #
  # source://webauthn//lib/webauthn/fake_authenticator.rb#103
  def credentials; end

  # source://webauthn//lib/webauthn/fake_authenticator.rb#109
  def hashed(target); end

  # source://webauthn//lib/webauthn/fake_authenticator.rb#105
  def new_credential; end
end
...
class WebAuthn::FakeAuthenticator::AuthenticatorData
  ...
  # source://webauthn//lib/webauthn/fake_authenticator/authenticator_data.rb#149
...
class WebAuthn::FakeClient
  ...
  def create(challenge: T.unsafe(nil), rp_id: T.unsafe(nil), user_present: T.unsafe(nil), user_verified: T.unsafe(nil), backup_eligibility: T.unsafe(nil), backup_state: T.unsafe(nil), attested_credential_data: T.unsafe(nil), extensions: T.unsafe(nil)); end
  ...
  # source://webauthn//lib/webauthn/fake_client.rb#76
  ...
  #
  # source://webauthn//lib/webauthn/fake_client.rb#124
  def authenticator; end

  # source://webauthn//lib/webauthn/fake_client.rb#126
  def data_json_for(method, challenge); end

  # source://webauthn//lib/webauthn/fake_client.rb#140
  def encoder; end

  # source://webauthn//lib/webauthn/fake_client.rb#152
  def fake_challenge; end

  # source://webauthn//lib/webauthn/fake_client.rb#156
  def fake_origin; end

  # source://webauthn//lib/webauthn/fake_client.rb#148
  def hashed(data); end

  # source://webauthn//lib/webauthn/fake_client.rb#144
  def internal_encoder; end

  # source://webauthn//lib/webauthn/fake_client.rb#160
